...
const CompleteSellerPayment = ({ completeDatas, loading }) => {
  ...
  function gridUrlTemplate(props) {
    return (
      <Link
        to={`/paymentsellerpreview/${encryptData(props.id)}`
        }
  ...
  const finalData = completeDatas?.map((item, index) => {
    return {
      ...item,
          ...
          <div className="row">
            {loading ?
              ...
              <div className="col-12">
                ...
                <div className="-body">
                  <h4 className="page_heading">Complete Payment To Seller Reports</h4>
                  <div className="col-lg-12  mb-4 mt-4">
                    ...
                    >
                      <ColumnsDirective>
                        ...
                        <ColumnDirective field='Prop_ID' headerText='Property ID' width='150' template={ProjectID} />
                        <ColumnDirective field='Date' headerText='date' width='170' />
                        <ColumnDirective field='Seller_Name' headerText='Seller Name' width='170' />
                        <ColumnDirective field='Age' headerText='Age' width='170' />
                        <ColumnDirective
                          field="Amount"
                        ...
                        <ColumnDirective
                          ...
                          width="170"
                        />
                        <ColumnDirective field='subpro_name' headerText='Status' width='180' />
                      </ColumnsDirective>
...
export default CompleteSellerPayment
