...
const PendingSellerPayment = ({ pendingDatas, loading }) => {
    ...
    const finalData = pendingDatas?.map((item, index) => {
        return {
            ...item,
                    ...
                    <div className="row">
                        {loading ?
                            ...
                            <div className="col-12">
                                {/* <div className="card"> */}
                                <div className="-body">
                                    <h4 className="page_heading">Pending Payment To Seller Reports</h4>
...
export default PendingSellerPayment
