...
function ActiveTickets() {
  const columns = [
    ...
    },
    {
      ...
      cell: (row) => (
        <div>
          <button className="btn btn_pdf light btn-info">Active</button>
        </div>
      ),
    },
      ...
      cell: (row) => (
        <div>
          <Dropdown>
            <Dropdown.Toggle
              variant="success"
              className="btn_pdf light btn-success"
              id="dropdown-basic"
            >
              Assign
            </Dropdown.Toggle>
            ...
            <div className="col-12">
              <div className="card">
                <div className="card-header">
                  <div className="d-flex">
                    <h4 className="page_heading">Active Tickets</h4>
                    <div style={{ marginLeft: "auto" }}>
                      <ExportButton
                        columns={columns}
                        data={filterdata}
                        filename={"Active_Tickets.csv"}
                      />
                    </div>
                  </div>
                </div>
