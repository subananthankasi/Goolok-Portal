...
function Hold() {
  const columns = [
    ...
    },
    {
      ...
      cell: (row) => (
        <div>
          <button className="btn btn_pdf light btn-warning">Hold</button>
        </div>
      ), 
    },

    {
      ...
      cell: (row) => (
        <div>
          <Dropdown>
            <Dropdown.Toggle variant="success" className="btn_pdf light" id="dropdown-basic">
              Assign
            </Dropdown.Toggle>
            ...
            <div className="col-12">
              <div className="card">
                <div className="card-header">
                  <div className="d-flex">
                    <h4 className="page_heading">Hold Tickets</h4>
                    <div style={{ marginLeft: "auto" }}>
                      <ExportButton
                        columns={columns}
                        data={filterdata}
                        filename={"Hold_Tickets.csv"}
                      />
                    </div>
                  </div>
                </div>
