...
const CompleteAfterSale = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(
                `${API_BASE_URL}/aftersaledpt?id=${staffid.loginid}&status=complete`,
                {
                    headers: {
                        "Pr-Root": "land",
                    },
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/aftersale/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("complete")}/${encryptData(rowData.bid)}/${encryptData(rowData.booking_no)}/${encryptData(rowData.block_id)}`);
    };
...
export default CompleteAfterSale;
