...
const PendingAfterSale = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/aftersale/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("pending")}/${encryptData(rowData.bid)}/${encryptData(rowData.booking_no)}/${encryptData(rowData.block_id)}`);
    };
...
export default PendingAfterSale