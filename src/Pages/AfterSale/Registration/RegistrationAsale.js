...
import WaitingRegAsale from "./WaitingRegAsale";
import PendingRegAsale from "./PendingRegAsale";
import CompleteRegAsale from "./CompleteRegAsale";


const RegistrationAsale = () => {
...
export default RegistrationAsale;
