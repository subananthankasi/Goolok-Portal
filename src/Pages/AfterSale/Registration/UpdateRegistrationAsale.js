...
import WholeRegistrationAsale from "./RegistraionAsaleComponents/WholeRegistrationAsale";
...
const UpdateRegistrationAsale = () => {
  const { eid, id, status, booking_id, shortform, booking_no, pagetype, block_id } =
    useParams();
...
export default UpdateRegistrationAsale;
