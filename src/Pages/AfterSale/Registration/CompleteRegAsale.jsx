...
const CompleteRegAsale = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/registration/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("complete")}/${encryptData(rowData.bid)}/${encryptData(rowData.booking_no)}/${encryptData("complete")}/${encryptData(rowData.block_id)}`);
    };
...
export default CompleteRegAsale;
