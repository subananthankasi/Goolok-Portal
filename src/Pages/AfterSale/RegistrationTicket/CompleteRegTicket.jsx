...
const CompleteRegTicket = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/registrationticket/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("complete")}/${encryptData(rowData.bid)}/${encryptData(rowData.shortform)}/${encryptData(rowData.booking_no)}/${encryptData(rowData.block_id)}`);
    };
