...
const WaitingPaymentScheduleAsale = () => {
    const [WaitingData, setWaitingData] = useState([]);

    const fetchData = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/schedule/new`, {
                headers: {
                    "Pr-Root": "land",
                },
            });
    ...
    const handleConfirm = async () => {
        ...
        try {
            await axios.put(`${API_BASE_URL}/schedule/${docId}`, payload, {
                headers: {
...
export default WaitingPaymentScheduleAsale;
