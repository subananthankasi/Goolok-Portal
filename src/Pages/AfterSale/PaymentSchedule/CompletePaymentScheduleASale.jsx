...
const CompletePaymentScheduleASale = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(
                `${API_BASE_URL}/schedule?id=${staffid.loginid}&status=complete`,
                {
                    headers: {
                        "Pr-Root": "land",
                    },
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/paymentschedule_AfterSale/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("complete")}/${encryptData(rowData.booking_id)}/${encryptData(rowData.booking_no)}`);
    };
...
export default CompletePaymentScheduleASale;
