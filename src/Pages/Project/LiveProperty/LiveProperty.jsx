...
const LiveProperty = () => {
  ...
  function gridUrlTemplate(props) {
    return (
      <Link
        to={`/view_details/${encryptData(props.id)}/${encryptData(props.subpro_name)}/${encryptData(props.property_type)}`
        }
              ...
              <div className="col-12">
                <div className="card">
                  <div className="card-body">
                    <h4 className="page_heading">Live Property</h4>
                    <div className="col-lg-12  mb-4 mt-4">
                      ...
                      >
                        <ColumnsDirective>
                          ...
                          <ColumnDirective field='property_main_title' headerText='Property Title' width='170' />
                          <ColumnDirective field='customer' headerText='Property Owner' width='170' />
                          <ColumnDirective
                            field="property_type"
                          ...
                          <ColumnDirective field='live_date' headerText='Property date' width='170' />
