...
const CancelProperty = () => {
  ...
  const renderStatusButton = (props) => {
    return (
      <button
        ...
        style={{ background: "#ff00002e", borderLeft: "2px solid #f90505", width: "70px", height: "30px", color: "#181e25", fontSize: "14px", fontWeight: "400" }}
      >
        Cancel
      </button>
    )
  ...
  const CreatedAtTemplate = (props) => {
    return <span>{formatTime(props.created_at)}</span>;
  };
  useEffect(() => {
              ...
              <div className="col-12">
                <div className="card">
                  <div className="card-body">
                    <h4 className="page_heading">Cancel Property</h4>
