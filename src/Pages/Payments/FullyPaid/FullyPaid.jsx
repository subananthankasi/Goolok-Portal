...
import ViewFullyPaid from "./ViewFullyPaidPayment";
...
function FullyPaid() {
  ...
  return (
    <>
       <ViewFullyPaid isOpen={isModalOpen} closeModal={closeModal} />
          ...
          <div className="row">
            <div className="col-12">
              <div className="card">
                ...
                <div className="d-flex">
                  <h4 className="page_heading">Fully Paid Details</h4>
                   <div style={{marginLeft:'auto'}}><ExportButton columns={columns1} data={filterdata} filename={'FullyPaid.csv'}/></div>
                  </div>
                </div>
