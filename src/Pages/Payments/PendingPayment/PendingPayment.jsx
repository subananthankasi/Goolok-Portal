...
import ViewPendingPayment from "./ViewPendingPayment";
...
function PendingPayment() {
  ...
  return (
    <>
       <ViewPendingPayment isOpen={isModalOpen} closeModal={closeModal} />
          ...
          <div className="row">
            <div className="col-12">
              <div className="card">
                ...
                <div className="d-flex">
                  <h4 className="page_heading">Pending Payment Details</h4>
                   <div style={{marginLeft:'auto'}}><ExportButton columns={columns1} data={filterdata} filename={'PendingPayment.csv'}/></div>
                  </div>
                </div>
