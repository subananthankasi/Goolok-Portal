...
const ViewPendingPayment = ({ isOpen, closeModal }) => {
    const columns = [
        {
          name: "S.no",
      ...
      <div className="modal-dialog modal-lg" role="document">
        <div className="modal-content">
          ...
          <div className="d-flex" style={{ alignItems: "center" }}>
            <h4 className="page_subheading m-3">Pending Payment Details</h4>
            <button
              type="button"
          ...
          <div className="card-body p-3">
            ...
            <div className="row">
                <div className="text-end d-flex ">
                  <div style={{marginLeft:'auto'}}><ExportButton columns={columns} data={filterdata} filename={'PendingPayment.csv'}/></div>
