...
const PendingLandOwnerPlot = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/plot_landowner_agreement/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}/${encryptData(rowData.subpro_name)}`);
  };
...
export default PendingLandOwnerPlot;
