...
const CompletedLawyerPlot = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/plot_lawyer_document/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('complete')}`);
    };
...
export default CompletedLawyerPlot;
