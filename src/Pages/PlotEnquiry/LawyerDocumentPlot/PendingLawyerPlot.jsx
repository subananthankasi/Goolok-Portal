...
const PendingLawyerPlot = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/plot_lawyer_document/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
...
export default PendingLawyerPlot;
