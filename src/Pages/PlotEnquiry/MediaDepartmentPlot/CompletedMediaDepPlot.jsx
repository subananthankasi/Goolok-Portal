...
const CompletedMediaDepPlot = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/plot_media_department/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("complete")}/${encryptData(rowData.subpro_name)}`);
        // navigate(`/plot_media_department/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("complete")}`);
    };
    return (
        <>
...
export default CompletedMediaDepPlot