...
function PendingProposalPlot() {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/plot_price_proposal/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
...
export default PendingProposalPlot;
