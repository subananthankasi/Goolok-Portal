...
function PendingLocationPlot() {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/plot_location/${encryptData(rowData.enqry_id)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
...
export default PendingLocationPlot;
