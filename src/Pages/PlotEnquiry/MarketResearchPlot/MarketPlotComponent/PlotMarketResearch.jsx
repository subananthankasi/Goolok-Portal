...
import CustomerMarketPlot from "./CustomerMarketPlot";
import NearbyMarketResearchPlot from "./NearbyMarketResearchPlot";
import { useSelector } from "react-redux";

export const PlotMarketResearch = ({ eid, marketid, status, pagetype }) => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      navigate("/plot_market_research#Complete");
    } catch (error) {
      const errorMessage =
