...
import WaitingFieldSurveyPlot from "./WaitingFieldSurveyPlot";
import PendingFieldSurveyPlot from "./PendingFieldSurveyPlot";
import CompletedFieldSurveyPlot from "./CompletedFieldSurveyPlot";
            ...
            <div className="col-12">
              <div className="card">
                ...
                <div className="card-b ody">
                  ...
                  {step === 2 && (
                    <>
                      <PendingFieldSurveyPlot />

                    </>
                  )}
                  {step === 3 && (
                    <>
                      <CompletedFieldSurveyPlot />
...
export default FieldSurveyPlot;
