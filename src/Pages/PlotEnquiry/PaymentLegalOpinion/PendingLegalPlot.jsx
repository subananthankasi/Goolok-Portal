...
const PendingLegalPlot = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/plot_payment_legal_opinion/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
...
export default PendingLegalPlot;
