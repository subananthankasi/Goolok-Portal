...
const CompletedPricingDepPlot = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/plot_pricing_department/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("complete")}/${encryptData(rowData.subpro_name)}`);
...
export default CompletedPricingDepPlot