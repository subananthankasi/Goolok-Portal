...
import { pricingPendingThunk } from '../../../Redux/Actions/Enquiry/PricingEnquiryThunk';
...
const PendingPricingDepPlot = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/pricingdpt?id=${staffid.loginid}&status=pending`, {
                headers: {
                    "Pr-Root": "plot"
                }
            });
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/plot_pricing_department/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("pending")}/${encryptData(rowData.subpro_name)}`);
    };
                        ...
                        <div className="col-12">
                            <div className="">
                                <div className="card-body">
                                    <h4 className="page_heading">Pending Pricing Report</h4>
...
export default PendingPricingDepPlot