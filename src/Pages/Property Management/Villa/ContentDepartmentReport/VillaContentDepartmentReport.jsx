...
function VillaContentDepartmentReport() {
  const columns = [
    {
      name: "S.no",
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="d-flex">
          <Link to='/villa_Content_writing_department'
          ...
          <div className="row">
            <div className="col-12">
              <div className="card">
                ...
                <div className="d-flex">
                  <h4 className="page_heading">Villa Content writing Report</h4>
...
export default VillaContentDepartmentReport;
