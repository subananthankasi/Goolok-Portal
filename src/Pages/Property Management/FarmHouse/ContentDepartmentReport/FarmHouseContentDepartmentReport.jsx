...
function FarmHouseContentDepartmentReport() {
  const columns = [
    {
      name: "S.no",
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="d-flex">
          <Link to='/farm_house_Content_writing_department'
          ...
          <div className="row">
            <div className="col-12">
              <div className="card">
                ...
                <div className="d-flex">
                  <h4 className="page_heading">Farm House Content writing Report</h4>
...
export default FarmHouseContentDepartmentReport;
