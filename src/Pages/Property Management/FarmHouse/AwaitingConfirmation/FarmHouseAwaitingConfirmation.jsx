...
function FarmHouseAwaitingConfirmation() {
  const percentage = 89;
  ...
  const columns = [
    ...
    
    {
      ...
      cell: (row) => (
        <div className="d-flex">
          <button  
            className="btn btn_pdf btn-outline-danger "  data-tooltip-id="status" onClick={() =>openModal()}
          >
            Status
          </button>
  ...
  return (
    <>
       <StatusUpdate  isOpen={isModalOpen}   closeModal={closeModal} />
          ...
          <div className="row">
            <div className="col-12">
              <div className="card">
                ...
                <div className="d-flex">
                  <h4 className="page_heading">Farm House Awaiting Confirmation</h4>
                   <div style={{marginLeft:'auto'}}><ExportButton columns={columns} data={filterdata} filename={'Awaiting_Property.csv'}/></div>
                  </div>
                </div>
...
export default FarmHouseAwaitingConfirmation;
