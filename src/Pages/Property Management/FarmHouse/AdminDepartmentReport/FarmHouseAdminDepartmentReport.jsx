...
function FarmHouseAdminDepartmentReport() {
  const percentage = 89;
  const columns = [
    {
      name: "S.no",
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="d-flex">
          <Link to='/farm_house_admin_department'
          ...
          <div className="row">
            <div className="col-12">
              <div className="card">
                ...
                <div className="d-flex">
                  <h4 className="page_heading">Farm House Admin Department Report</h4>
                   <div style={{marginLeft:'auto'}}><ExportButton columns={columns} data={filterdata} filename={'Admin_department.csv'}/></div>
                  </div>
                </div>
...
export default FarmHouseAdminDepartmentReport;
