    ...
    },
    {
      ...
      cell: (row) => (
        <div className="d-flex">
          <Link to='/farm_house_owner_Agreement'
          ...
          <div className="row">
            <div className="col-12">
              <div className="card">
                ...
                <div className="d-flex">
                  <h4 className="page_heading">Farm House Owner Agreement Report</h4>
...
export default FarmHouseOwnerReport;
