...
function FarmHouseFieldSurveyReport() {
  const percentage = 89;
  const columns = [
    {
      name: "S.no",
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="d-flex">
          <Link to='/farm_field_survey_department'
          ...
          <div className="row">
            <div className="col-12">
              <div className="card">
                ...
                <div className="d-flex">
                  <h4 className="page_heading">Farm House Field Survey Report</h4>
...
export default FarmHouseFieldSurveyReport;
