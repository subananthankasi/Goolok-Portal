...
function AmenitiesCharges({ basicDetails,surveyDetails,propertyID,statusType}) {
...
const enrichedLandData = finalData.map((item, index) => {
  ...
  const handleSubmit = async(e) => {
    ...
    try{
      const response = await axios.put(`${API_BASE_URL}/agreement/${propertyID}`, priceDetails, {
        headers: {
