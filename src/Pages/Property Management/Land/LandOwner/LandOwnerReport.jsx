...
import LandOwnerStatus from "./LandOwnerStatus";
import Spinner from 'react-bootstrap/Spinner';

function LandOwnerReport() {
  ...
  let gridInstance;
    ...
    function gridUrlTemplate(props) { 
      return ( 
        <Link to={`/Land_owner_Agreement?id=${props.id}&status=${statusUrl.status}`}
...
function completionPrecentage(props) { 
  ...
  return (
    <>
           <LandOwnerStatus isOpen={isModalOpenStatus} closeModal={closeModalStatus} editData={editData} statusUrl={statusUrl.status}/>   
        ...
        <div className="container">
          ...
          <div className="col-12">
              <div className="card"> 
                ...
                <h4 className="page_heading">Land Owner Agreement Report ({statusUrl.status})</h4>
...
export default LandOwnerReport;
