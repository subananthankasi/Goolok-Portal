...
function LandAdminDepartmentReport() {
  ...
  let gridInstance;
    ...
    function gridUrlTemplate(props) { 
      return ( 
        <Link to={`/land_admin_department?id=${props.id}&status=${statusUrl.status}`}
        ...
        <div className="container">
          ...
          <div className="col-12">
              <div className="card"> 
                ...
                <h4 className="page_heading">Land Admin Department Report ({statusUrl.status})</h4>
...
export default LandAdminDepartmentReport;
