...
function FieldSurveyReport() {
  ...
  function gridUrlTemplate(props) {
    return (
      <Link to={`/land_field_survey_department?id=${props.id}&pid=${props.survey_project}&status=${statusUrl.status}`}
              ...
              <div className="col-12">
                <div className="card">
                  <div className="card-body">
                    <h4 className="page_heading">Land Field Survey Report ({statusUrl.status})</h4>
...
export default FieldSurveyReport;
