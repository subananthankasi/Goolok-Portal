...
const LegalQcStatusUpdate = ({ isOpen, closeModal, editData,statusUrl }) => {
  ...
  const changeStatus = (statusUrl) => {
    ...
    switch (statusUrl) {
      case 'new':
        ...
        break;
      case 'pending':
        apiEndpoint = 'approvedsurvey';
        heading = 'Proceed to owner agreement';
        break;
      case 'rework':
        apiEndpoint = 'survey';
        heading = 'Proceed to Admin Department';
  ...
  const handleSubmit = async (e) => {
    ...
    try { 
      ...
      let response;
      if (statusUrl === 'new') {
          response = await axios.put(`${API_BASE_URL}/${apiEndpoint}/${editData}`, formData, {
          headers: {
...
export default LegalQcStatusUpdate;
