...
function PropertyCharges() {
  ...
  const  columns = [
    ...
    {
      name: "Goolok Plot price per unit",
      selector: (row) => row["Goolok Plot price per unit"],
      sortable: true,
      wrap: true,
      width:"180px"
    },  
    ...
    {
      name: "Goolok Built up area cost per unit",
      selector: (row) => row["Goolok Built up area cost per unit"],
      sortable: true,
      wrap: true,
      width:"180px"
    },  
    ...
    },  
    {
      ...
      selector: (row) => row["Goolok Total cost"],
      sortable: true,
      wrap: true,
    },  
  ];
          ...
          <div className="row mt-4">
            ...
            <div className="col-auto">
              ...
              <ExportButton
                ...
                filename={"Apartment_Goolok_Charges_uploading_format.csv"}
              />
            </div>
