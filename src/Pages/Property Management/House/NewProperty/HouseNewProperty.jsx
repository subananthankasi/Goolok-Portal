                    ...
                    {step === 1 && (
                      ...
                      <div className="mb-3 col-md-12 col-lg-4">
                          ...
                          <select id="inputState" className="form-select">
                              <option value="land">Independent House</option> 
                              <option value="land">Service Apartments</option> 
                              <option value="land">Commercial Complex</option> 
                          </select>
                        </div> 
...
export default HouseNewProperty;
