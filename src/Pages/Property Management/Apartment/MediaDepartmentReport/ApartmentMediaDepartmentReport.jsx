...
function ApartmentMediaDepartmentReport() {
  const percentage = 89;
  const columns = [
    {
      name: "S.no",
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="d-flex">
          <Link to='/apartment_media_department'
          ...
          <div className="row">
            <div className="col-12">
              <div className="card">
                ...
                <div className="d-flex">
                  <h4 className="page_heading">Apartment Media Department Report</h4>
...
export default ApartmentMediaDepartmentReport;
