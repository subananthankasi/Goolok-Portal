                    ...
                    {step === 1 && (
                      ...
                      <div className="mb-3 col-md-12 col-lg-4">
                          ...
                          <select id="inputState" className="form-select">
                              ...
                              <option value="layout">Building Floor</option>
                              <option value="plot">Service Apartment</option>
                              <option value="plot">Commercial Complex</option>
                          </select>
                        </div> 
...
export default ApartmentNewProperty;
