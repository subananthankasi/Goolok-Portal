...
function LayoutFieldSurveyReport() {
  ...
  let gridInstance;
    ...
    function gridUrlTemplate(props) { 
      return ( 
        <Link to={`/layout_field_survey_department?id=${props.id}&pid=${props.survey_project}&status=${statusUrl.status}`}
 ...
 function StatusModalOpen(props) {
  ...
  return (
    <>
       <FieldSurveyStatus isOpen={isModalOpenStatus} closeModal={closeModalStatus} editData={editData} statusUrl={statusUrl.status}/>   
          ...
          :
            <div className="col-12">
              <div className="card"> 
                ...
                <h4 className="page_heading">Layout Field Survey Report ({statusUrl.status})</h4>
...
export default LayoutFieldSurveyReport;
