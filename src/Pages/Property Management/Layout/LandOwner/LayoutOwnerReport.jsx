...
import LayoutOwnerStatus from "./LayoutOwnerStatus";

function LayoutOwnerReport() {
  ...
  let gridInstance;
    ...
    function gridUrlTemplate(props) { 
      return ( 
        <Link to={`/layout_owner_Agreement?id=${props.id}&status=${statusUrl.status}`}
...
function completionPrecentage(props) { 
  ...
  return (
    <>
           <LayoutOwnerStatus isOpen={isModalOpenStatus} closeModal={closeModalStatus} editData={editData} statusUrl={statusUrl.status}/>   
        ...
        <div className="container">
          ...
          <div className="col-12">
              <div className="card"> 
                ...
                <h4 className="page_heading">Layout Owner Agreement Report ({statusUrl.status})</h4>
...
export default LayoutOwnerReport;
