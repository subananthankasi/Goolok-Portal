...
function LayoutMediaDepartmentReport() {
  ...
  let gridInstance;
    ...
    function gridUrlTemplate(props) { 
      return ( 
        <Link to={`/layout_media_department?id=${props.id}&projectid=${props.media_projectid}&status=${statusUrl.status}`}
        ...
        <div className="container">
          ...
          <div className="col-12">
              <div className="card"> 
                ...
                <h4 className="page_heading">Layout Media Department Report ({statusUrl.status})</h4>
...
export default LayoutMediaDepartmentReport;
