...
import { addLandNewProperty } from "../../../../Redux/Actions/PropertyManagement/Land/LandNewPropertyActions";
import Spinner from "react-bootstrap/Spinner";
import { fetchUnit } from "../../../../Redux/Actions/MasterPage/UnitAction";
import Toast from "../../../../Utils/Toast";

function LayoutNewProperty() {
  const columns1 = [
    {
      name: "S.No",
    ...
    // {
    //   name: "Rate per unit",
    //   selector: (row) => row["Rate per unit"],
    //   sortable: true,
    //   width:"150px",
    //   wrap: true,
    // },
  ...
  useEffect(() => {
    setFormData({
      ...
      survey: nameChangeData ? nameChangeData : "",
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.isValid) {
      ...
      try {
        const response = await axios.post(`${API_BASE_URL}/layout`, form, {
          headers: {
            'Content-Type': 'multipart/form-data',
          },
        }); 
        if (response.status === 201) { 
           Toast({ message: "Layout Created Successfully", type: "success" }); 
        } else { 
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-12 col-lg-4 mb-3 ">
                          ...
                          <div className="input-group">
                            <input type="text" className="form-control"  name="area" onChange={handleChangeForm}/>
                            <button
                        ...
                        <div className="col-md-12 col-lg-4 mb-3 ">
                          ...
                          <div className="input-group">
                            <input type="text" className="form-control"  name="saleable" onChange={handleChangeForm}/>
                            <button
                              className="btn btn-outline-secondary dropdown-toggle"
                              type="button"
                              data-bs-toggle="dropdown"
                        ...
                        <div className="col-md-12 col-lg-4 mb-3 ">
                          ...
                          <input
                            ...
                            className="form-control"
                            id="lastName"
                            name="total_plot" onChange={handleChangeForm}
                          />
                        </div>
                        ...
                        <div className="col-md-12 col-lg-4 mb-3 ">
                          ...
                          <input
                            ...
                            className="form-control"
                            id="lastName"
                            name="available" onChange={handleChangeForm}
                          />
                        </div>
                        ...
                        <div className="text-end py-3 px-3">
                          ...
                          <button className="btn1" onClick={(e) => { e.preventDefault(); firstPage() }}>
                            Next
                          </button>
                        </div>
                      </div>
                    ...
                    <div className={step === 2 ? "d-block" : "d-none"}>
                      <div className="row">
                        ...
                        <div className="text-end py-3 px-3">
                          ...
                          <button className="btn1"  onClick={(e) => { e.preventDefault(); secondPage(); }}>
                            Next
                          </button>
                        </div>
                      </div>
...
export default LayoutNewProperty;
