...
import {
    mediaDeletePhotoThunk,
    mediaGetPhotoThunk,
    mediaPostPhotoThunk,
    mediaUpdatePhotoThunk,
} from "../../../../Redux/Actions/Enquiry/MediaDptEnq/MediaDptPhotoThunk";
...
const AddPhotosLayout = ({ eid, status, pagetype }) => {
    ...
    const deleteUnitsDialogFooter = (
        <div className="d-flex justify-content-end gap-2 mt-4">
            ...
            {/* <button type='button' className='btn btn-outline-primary' onClick={() => setDeleteDialog(false)}>Cancel</button>
...
export default AddPhotosLayout;
