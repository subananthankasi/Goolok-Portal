...
const CompleteMediaLayout = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/layout_media/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("complete")}`);
...
export default CompleteMediaLayout