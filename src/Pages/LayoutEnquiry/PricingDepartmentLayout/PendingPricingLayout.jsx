...
const PendingPricingLayout = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/layout_pricing/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("pending")}`);
    };
...
export default PendingPricingLayout