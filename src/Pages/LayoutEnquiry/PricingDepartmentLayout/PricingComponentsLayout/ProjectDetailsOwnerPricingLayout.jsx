        ...
        <div className="card shadow border-0 mb-4">
          <div className="card shadow border-0 p-4">
            <div className="d-flex justify-content-between align-items-center">
              <h6 className="text-center">Plot Details</h6>
              {/* {staffid.Login === "staff" &&
              ...
              >
                ...
                >
                  ...
                  <Column width={160}>
                    ...
                    <Cell>{(rowData) => `₹ ${rowData.development_charges ?? "0"}`}</Cell>
                  </Column>
                  <Column width={160}>
                  ...
                  <Column width={130}>
                    ...
                    <Cell>{(rowData) => `₹${rowData.plot_cost_total ?? "0"}`}</Cell>
                ...
                >
                  ...
                  <Column width={130}>
                    ...
                    <Cell>{(rowData) => `₹${rowData.gst_amount ?? "0"}`}</Cell>

                  </Column>
                  <Column width={130}>
                    <HeaderCell>Total </HeaderCell>
                    {/* <Cell dataKey="association_cost_total" /> */}
                    <Cell>{(rowData) => `₹${rowData.association_cost_total ?? "0"}`}</Cell>
                ...
                >
                  ...
                  <Column width={130}>
                    ...
                    <Cell>{(rowData) => `₹${rowData.registration_total ?? "0"}`}</Cell>
                    ...
                    <Column width={80} fixed="right" align="center">
                      ...
                      <Cell>
                        {(rowData) =>
                          ...
                          ) : <p style={{ color: "green", fontWeight: "600" }}>Booked</p>
                        }
                      </Cell>
                    </Column>
                  )}
