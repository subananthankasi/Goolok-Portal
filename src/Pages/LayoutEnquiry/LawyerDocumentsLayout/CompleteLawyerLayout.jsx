...
const CompleteLawyerLayout = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/layout_lawyerdocument/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('complete')}/${encryptData(rowData.subpro_name)}`);
    };
...
export default CompleteLawyerLayout;
