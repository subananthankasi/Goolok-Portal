...
import CustomerMarketLayout from "./CustomerMarketLayout";
import NearbyMarketLayout from "./NearbyMarketLayout";
import { useSelector } from "react-redux";


export const WholeMarketResearchLayout = ({
  eid,
  marketid,
  status,
  pagetype,
  ...
  const handleConfirm = async () => {
    ...
    try {
      await axios.get(`${API_BASE_URL}/layoutmarketconfirm/${marketid}`);
