...
const CustomerMarketLayout = ({ eid, marketid, status, pagetype }) => {
  ...
  const formik = useFormik({
    ...
    //     location_advantages: yup.string()
    //         .required('location_advantages is required !!')
    //         .matches(/^[A-Za-z\s]+$/, 'location_advantages must contain only letters and spaces'),
    //     transportation_feasibility: yup.string().required('transportation_feasibility is required !!'),
    ...
    //     new_developments: yup.string()
    //         .required('new_developments is required !!')
    //         .matches(/^[A-Za-z\s]+$/, 'new_developments must contain only letters and spaces'),
    ...
    //     developments: yup.string().required('project developments is required !!'),
...
export default CustomerMarketLayout;
