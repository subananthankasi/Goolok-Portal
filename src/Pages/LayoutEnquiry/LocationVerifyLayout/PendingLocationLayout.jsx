...
function PendingLocationLayout() {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/layout_location/${encryptData(rowData.enqry_id)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
...
export default PendingLocationLayout;
