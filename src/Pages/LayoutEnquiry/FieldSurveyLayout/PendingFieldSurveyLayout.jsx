...
const PendingFieldSurveyLayout = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/layout_fieldsurvey/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
  };
...
export default PendingFieldSurveyLayout;
