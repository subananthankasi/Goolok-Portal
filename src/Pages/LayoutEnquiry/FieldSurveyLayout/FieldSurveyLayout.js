...
import WaitingFieldSurveyLayout from "./WaitingFieldSurveyLayout";
import PendingFieldSurveyLayout from "./PendingFieldSurveyLayout";
import CompleteFieldSurveyLayout from "./CompleteFieldSurveyLayout";


const FieldSurveyLayout = () => {
            ...
            <div className="col-12">
              <div className="card">
                ...
                <div className="card-b ody">
                  ...
                  {step === 2 && (
                    <>
                      <PendingFieldSurveyLayout/>

                    </>
                  )}
                  {step === 3 && (
                    <>
                      <CompleteFieldSurveyLayout />
...
export default FieldSurveyLayout;
