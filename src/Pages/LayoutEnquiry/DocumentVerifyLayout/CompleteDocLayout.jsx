...
function CompleteDocLayout() {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/layout_document/${encryptData(rowData.id)}/${encryptData(rowData.userid)}/${encryptData("complete")}`);
  };
...
export default CompleteDocLayout;
