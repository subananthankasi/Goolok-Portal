...
const WholeDocumentLayout = ({ eid, id, status, pagetype }) => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      navigate("/layout_document#Complete");
                  ...
                  <div className="row">
                    <div className="col-6">
                      <div className="row mt-5">
                        ...
                        <div className="col-6">{projectData?.approval_type}</div>
                      </div>
                      ...
                      <div className=" row mt-5 mb-5">
                        ...
                        <div className="col-6">{projectData?.saleable_sqft}</div>
                      </div>
                    </div>
                    <div className="col-6">
                      <div className="row mt-5">
                      ...
                      <div className=" row mt-5 mb-5">
                        <div className="col-6"> Total saleable no of units :</div>
                        <div className="col-6">{projectData?.total_saleable_units}</div>
                      </div>
                    </div>
                  </div>
                </TabPanel>
...
export default WholeDocumentLayout;
