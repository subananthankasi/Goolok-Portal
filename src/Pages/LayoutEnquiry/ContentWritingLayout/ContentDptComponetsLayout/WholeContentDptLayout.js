...
import DescriptionContentLayout from './DescriptionContentLayout';
import LocalitiesContentLayout from './LocalitiesContentLayout';
import TagsContentLayout from './TagsContentLayout';
...
const WholeContentDptLayout = ({ eid, id, status, pagetype,sub_property }) => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      navigate("/layout_contentwriting#Complete");
      ...
      <div className='p-2 mt-4'>
        <Tabs defaultActiveKey="1" >
          <Tabs.Tab eventKey="1" title="Description & Features">
            ...
            <DescriptionContentLayout eid={eid} id={id} status={status} sub_property ={sub_property} />
          </Tabs.Tab>
          <Tabs.Tab eventKey="2" title="Localities">
            <LocalitiesContentLayout eid={eid} id={id} status={status} />
          </Tabs.Tab>
          <Tabs.Tab eventKey="3" title="Tags">
            <TagsContentLayout eid={eid} id={id} status={status}/>
          </Tabs.Tab>
        </Tabs>
...
export default WholeContentDptLayout