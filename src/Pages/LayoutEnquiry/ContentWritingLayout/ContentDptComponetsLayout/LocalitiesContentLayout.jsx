...
import {
  localitiesDeleteThunk,
  localitiesGetThunk,
  localitiesPostThunk,
  localitiesUpdateThunk,
} from "../../../../Redux/Actions/Enquiry/ContentWritingThunk/LocalitiesThunk";
...
const LocalitiesContentLayout = ({ eid, id, status }) => {
                    ...
                    {hoveredMarker === index && (
                      ...
                      >
                        ...
                        >
                          <h6 style={{ fontWeight: "400", fontSize: "15px" }}>
                            {" "}
                            <LocationOnOutlinedIcon /> {title[index]}
                          </h6>
                          {distance && (
                            <h6 style={{ fontWeight: "400", fontSize: "15px" }}>
...
export default LocalitiesContentLayout;
