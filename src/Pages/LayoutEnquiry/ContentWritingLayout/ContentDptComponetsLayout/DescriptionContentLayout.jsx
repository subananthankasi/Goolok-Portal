...
import ProjectDetailsContentLayout from "./ProjectDetailsContentLayout";
import GeneralFeatureLayout from "./GeneralFeatureLayout";
import InteriorFeatureContentLayout from "./InteriorFeatureContentLayout";
import ExteriorFeatureContentLayout from "./ExteriorFeatureContentLayout";
import InvestmentStrategyContentLayout from "./InvestmentStrategyContentLayout";
import { OwnerProjectDetailsContentLayout } from "./OwnerProjectDetailsContentLayout";

const DescriptionContentLayout = ({ eid, id, status,sub_property }) => {
  ...
  return (
    <>
      ...
      <GeneralFeatureLayout eid={eid} id={id} status={status} />
      <InteriorFeatureContentLayout eid={eid} id={id} status={status} />
      <ExteriorFeatureContentLayout eid={eid} id={id} status={status} />
      <InvestmentStrategyContentLayout eid={eid} id={id} status={status} />
    </>
  );
};

export default DescriptionContentLayout;
