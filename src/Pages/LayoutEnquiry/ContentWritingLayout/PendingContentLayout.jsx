...
const PendingContentLayout = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/layout_contentwriting/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("pending")}`);
    };
...
export default PendingContentLayout