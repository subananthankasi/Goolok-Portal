...
const PendingOwnerlayout = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/layout_landowneragreement/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
  };
...
export default PendingOwnerlayout;
