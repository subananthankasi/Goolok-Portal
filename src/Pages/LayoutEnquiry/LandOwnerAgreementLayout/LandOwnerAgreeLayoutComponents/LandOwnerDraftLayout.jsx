...
const LandOwnerDraftLayout = ({ eid, id, status, sub_property, pagetype }) => {
  ...
  useEffect(() => {
    const landarea = parseFloat(formik.values.seleable_plots_units) || 0;
    const priceper = parseFloat(formik.values.priceper) || 0;
    const total_seleable_cost = landarea * priceper;
    formik.setFieldValue("total_seleable_cost", total_seleable_cost || "");
  }, [formik.values.seleable_plots_units, formik.values.priceper]);
              ...
              <div className="row">
                ...
                <div className="col-8 mb-3 ">
                  <input
                    ...
                    className="form-control"
                    placeholder="total saleable plots cost ..."
                    type="number"
...
export default LandOwnerDraftLayout;
