      ...
      >
        <form onSubmit={formik.handleSubmit} autoComplete="off">
          ...
          <div className="d-flex justify-content-end gap-2 mt-4">
            ...
            <button className="btn1" type="submit" onClick={() => setEditing(false)}>  {postLoading ? "Processing..." : "Save"}{" "}</button>
          </div>
        </form>
      </Dialog>
      {/**Delete */}
      ...
      >
        <form onSubmit={formik.handleSubmit} autoComplete="off">
          ...
          <div className="d-flex justify-content-end gap-2 mt-4">
            ...
            <button className="btn1" type="submit" onClick={() => setEditing(true)}>  {postLoading ? "Processing..." : "Save"}{" "}</button>
          </div>
        </form>
      </Dialog>
    </>
...
export default LandOwnerAgreeDetailsLayout;
