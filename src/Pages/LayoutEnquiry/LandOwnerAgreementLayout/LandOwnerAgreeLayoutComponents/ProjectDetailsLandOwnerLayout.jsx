...
export const ProjectDetailsLandOwnerLayout = ({ eid, id, status, pagetype }) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object().shape({
      ...
      plot_type: yup.string().required("Plot Type are required!"),
      ownersettlementcost: yup
        .string()
        .required("owner settlement cost are required!"),
      rate_sqft: yup.string().required("rate sqft are required!"),
