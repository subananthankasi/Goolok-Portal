                          ...
                          <div className="card">
                            <div className="card-header">
                              <div className="d-flex">
                                <h4 className="page_heading">Refund Amount Approve</h4>
                  ...
                  <div className="col-md-12 col-lg-6">
                    <div className="form-group mt-3">
                      <div className="row">
                        ...
                        <div className="col-5">
                        <select id="inputState" className="form-select">
                                  <option value="Enable">Plot 1</option>
                                  <option value="Disable">Plot 2</option>
                                </select>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="col-md-12 col-lg-6">
                    <div className="form-group mt-3">
                      <div className="row">
                        ...
                        <div className="col-5">
                        <select id="inputState" className="form-select">
                                  <option value="Enable">Customer 1</option>
                                  <option value="Disable">Customer 2</option>
                                </select>
                        </div>
                      </div>
                    </div>
...
export default RefundAmountApprove;
