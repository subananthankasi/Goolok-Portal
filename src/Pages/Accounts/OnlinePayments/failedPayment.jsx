...
function FailedPayments() {
  const columns = [
    ...
    },
    {
      name: "status",
      cell: (row) => ( 
          <button className="btn btn_pdf btn-outline-danger p-2">
               {row.status}
          </button>
            ...
            <div className="col-12">
              <div className="card">
                ...
                <div className="d-flex">
                  <h4 className="page_heading">Failed Payment Report</h4>
                   <div style={{marginLeft:'auto'}}><ExportButton columns={columns} data={filterdata} filename={'failed_payment.csv'}/></div>
                  </div>
                </div>
