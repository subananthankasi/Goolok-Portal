...
//             name: "Property ID",
//             selector: (row) =>
//                 Array.isArray(row?.property_id)
//                     ? row.property_id
//                         .map((id) => `PRP1${id}`)
//                         .join(", ")
//                     : row?.property_id
//                         ? `PRP1${row.property_id}`
//                         : "-",
//             sortable: true,
//             width: "300px",
//         },
...
//         },
//         {
//             name: "Coupon Combination",
//             selector: (row) => row?.coupon_combination,
//             sortable: true,
//             width: "210px",
//         },
//         {
...
//                     className="btn "
//                     onClick={() =>
//                         window.open(`${IMG_PATH}/discount/image/${row.image}`, "_blank")
//                     }
//                 >
...
//         formik.setFieldValue("subtitle", row.subtitle || "");
...
//         formik.setFieldValue("coupon_combination", row.coupon_combination || "");
//         formik.setFieldValue("min_range", row.min_range || "");
//         formik.setFieldValue("max_range", row.max_range || "");
...
//         setImgUrl(`${IMG_PATH}/discount/image/${row.image}`);
//     };
...
//         try {
//             setLoading(true);
//             const response = await axios.get(`${API_BASE_URL}/discountdeals`);
...
//         try {
//             await axios.delete(`${API_BASE_URL}/discountdeals/${selectedRowId}`);
//             fetchData();
...
//         const payload = {
//             ...values,
//             discount_section_name: "specialdiscount"
//         }
//         try {
...
//             coupon_combination: yup.string().required("Coupon combination is required"),
...
//                                 <h4 className="page_heading">Discount Reports</h4>
...
//                                     )}
//                             </div>
//                             {formik.values?.customer_type === "custom" && (
//                                 <div className="col-md-4 mb-3 ">
...
//                                 </label>
//                                 <select
//                                     name="coupon_combination"
//                                     className="form-select"
//                                     value={formik.values.coupon_combination}
//                                     onChange={formik.handleChange}
//                                     onBlur={formik.handleBlur}
//                                 >
//                                     <option value="">Select ...</option>
//                                     <option value="buyer">Can be combined with other coupon</option>
//                                     <option value="seller">No can't be combined with other coupon</option>
//                                 </select>
//                                 {formik.errors.coupon_combination &&
//                                     formik.touched.coupon_combination && (
//                                         <p style={{ color: "red", fontSize: "12px" }}>
//                                             {formik.errors.coupon_combination}
//                                         </p>
//                                     )}
    ...
    const handleDelete = async () => {
        try {
            const response = await axios.delete(
                `${API_BASE_URL}/discountdeals/${deleteId}`
            );
            fetchData();
