...
} from "../../../Redux/Actions/MasterPage/ContactPersonTalukThunk";
...
const TalukTable = () => {
  ...
  const isLoading = useSelector(
    (state) => state.contactPersonTalukData.get.loading
  );
  ...
  const updateLoading = useSelector(
    (state) => state.contactPersonTalukData.update.loading
  );
  ...
  const handleDelete = () => {
    try {
      dispatch(contactPersonTalukDeleteThunk(deleteId)).then(() => {
        dispatch(contactPersonTalukGetThunk());
      });
