...
const PendingContentWriting = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/contentWriting/${rowData.enqid}/${rowData.id}/pending/${encryptData(rowData.subpro_name)}`);
    };
...
export default PendingContentWriting