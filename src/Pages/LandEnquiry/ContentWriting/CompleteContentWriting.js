...
const CompleteContentWriting = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/contentWriting/${rowData.enqid}/${rowData.id}/complete/${encryptData(rowData.subpro_name)}`);
  };
...
export default CompleteContentWriting;
