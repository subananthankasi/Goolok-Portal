...
function PendingMarketResearch() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`${API_BASE_URL}/market?id=${staffid.loginid}&status=pending`, {
        headers: {
          "Pr-Root": "land"
        }
      });
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/market_research_add/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
  };
              ...
              <div className="col-12">
                <div className="">
                  <div className="card-body">
                    <h4 className="page_heading">Pending Market Research</h4>
...
export default PendingMarketResearch;
