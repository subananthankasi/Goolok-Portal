...
import NearbyMarketResearch from "./NearbyMarketResearch";

export const WholeMarketResearchLand = ({ eid, marketid, status, pagetype }) => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      navigate("/market_research_verification#Complete");
