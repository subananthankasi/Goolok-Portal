...
function WaitingMarketResearch() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`${API_BASE_URL}/market/new`, {
        headers: {
          "Pr-Root": "land"
        }
      })
  ...
  const handleConfirm = async () => {
    ...
    try {
      await axios.put(`${API_BASE_URL}/market/${docId}`, updateData, {
        headers: {
...
export default WaitingMarketResearch;
