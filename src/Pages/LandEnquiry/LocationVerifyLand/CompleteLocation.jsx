...
function CompleteLocation() {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/location_mapping/${encryptData(rowData.enqry_id)}/${encryptData(rowData.id)}/${encryptData('complete')}`);
  };
              ...
              <div className="col-12">
                <div className="">
                  <div className="card-body">
                    <h4 className="page_heading">Complete Location Report</h4>
