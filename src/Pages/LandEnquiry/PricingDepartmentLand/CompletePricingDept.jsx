...
const CompletePricingDept = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/pricingDepartment/${rowData.enqid}/${rowData.id}/complete/${encryptData(rowData.subpro_name)}`);
  };
...
export default CompletePricingDept