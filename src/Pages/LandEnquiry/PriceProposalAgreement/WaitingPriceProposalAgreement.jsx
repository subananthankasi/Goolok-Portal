...
function WaitingPriceProposalAgreement() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`${API_BASE_URL}/proposal/new`, {
        headers: {
          "Pr-Root": "land"
        }
      })
  ...
  const handleConfirm = async () => {
    ...
    try {
      await axios.put(`${API_BASE_URL}/proposal/${docId}`, updateData, {
        headers: {
...
export default WaitingPriceProposalAgreement;
