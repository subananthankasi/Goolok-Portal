...
function PendingPriceProposalAgreement() {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/price_proposal_agreement/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
  };
...
export default PendingPriceProposalAgreement;
