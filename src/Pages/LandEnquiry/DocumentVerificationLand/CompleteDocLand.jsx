...
function CompleteDocLand() {
    ...
    const handleRowSelect = (args) => {
        ...
        // navigate(`/document_verification/${encryptData(rowData.id)}/${encryptData(rowData.userid)}/${encryptData("complete")}`);
        navigate(`/document_verification/${encryptData(rowData.id)}/${encryptData(rowData.userid)}/${encryptData("complete")}`);
    };
...
export default CompleteDocLand;
