...
function PendingDocLand() {
            ...
            try {
                ...
                setenquiryDataFromWebsite(
                    response.data?.map((data, index) => ({
                        ...
                        count:
                            Math.floor(
                                (new Date() - new Date(data.created_at)) / 86400000
                            ) + " day",
                    }))
                );
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/document_verification/${encryptData(rowData.id)}/${encryptData(rowData.userid)}/${encryptData("pending")}`);
    };
