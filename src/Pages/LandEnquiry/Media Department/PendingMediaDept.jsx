...
const PendingMediaDept = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/mediadpt?id=${staffid.loginid}&status=pending`, {
                headers: {
                    "Pr-root": "land"
                }
            });
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/mediaDepartment/${rowData.enqid}/${rowData.id}/pending/${encryptData(rowData.subpro_name)}`);
    };
...
export default PendingMediaDept