...
const CompletePricingDptApart = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/apart_pricing_department/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("complete")}`);
  };
  return (
    <>
...
export default CompletePricingDptApart