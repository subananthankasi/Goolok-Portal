...
import { pricingDptGetThunk, pricingDptPostThunk } from "../../../../Redux/Actions/Enquiry/PricingEnquiryThunk";
import { pricingGetThunk } from "../../../../Redux/Actions/MasterPage/PricingThunk";
import DiscountPage from "../../../../Utils/Offers/DiscountPage";

const PricingDptApart = ({ eid, status, id, pagetype, discountPage }) => {
    ...
    <>
      ...
      <div className="card shadow border-0 mb-4 mt-3">
        <div className="card shadow border-0 p-4">
          {Array.isArray(parsedCharges) && parsedCharges.length > 0 ? (
...
export default PricingDptApart;
