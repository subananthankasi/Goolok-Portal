...
import { paymentScheduleEnqDeleteThunk, paymentSchedulEnqGetThunk } from "../../../../Redux/Actions/Enquiry/PaymentScheduleEnqThunk";
...
const PaymentScheduleStage = ({ eid, status, pagetype }) => {
        ...
        <>
          {row.payment_details ? (
            ...
            <div className="d-flex gap-2">
              {staffid.Login === "staff" &&
                pagetype !== "reminder" &&
                (status === "complete" || status === "pending") && enquiryDoumentData?.status !== "booking" ? (
                <>
                  <button
