...
const PendingPricingDptApart = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/apart_pricing_department/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("pending")}`);
    };
...
export default PendingPricingDptApart