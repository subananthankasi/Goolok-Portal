...
const PendingFieldSurveyApart = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/apart_field_survey/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
  };
...
export default PendingFieldSurveyApart;
