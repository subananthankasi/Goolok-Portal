...
function PendingProposalApart() {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/apart_price_proposal/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
...
export default PendingProposalApart;
