...
const PendingLandOwnerApart = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/apart_land_owner_agreement/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
  };
...
export default PendingLandOwnerApart;
