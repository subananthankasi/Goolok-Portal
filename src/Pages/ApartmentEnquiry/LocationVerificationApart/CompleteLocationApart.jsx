...
const CompleteLocationApart = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/apart_location_verification/${encryptData(rowData.enqry_id)}/${encryptData(rowData.id)}/${encryptData('complete')}`);
  };
  return (
    <>
...
export default CompleteLocationApart