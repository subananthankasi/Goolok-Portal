...
function PendingLocationApart() {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/apart_location_verification/${encryptData(rowData.enqry_id)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
...
export default PendingLocationApart;
