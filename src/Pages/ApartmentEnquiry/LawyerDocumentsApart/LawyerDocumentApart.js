...
import WaitingLawyerApart from "./WaitingLawyerApart";
import PendingLawyerApart from "./PendingLawyerApart";
import CompleteLawyerApart from "./CompleteLawyerApart";

const LawyerDocumentApart = () => {
...
export default LawyerDocumentApart;
