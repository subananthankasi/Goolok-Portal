...
const CompleteLawyerApart = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/apart_lawyer_documents/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('complete')}`);
    };
...
export default CompleteLawyerApart;
