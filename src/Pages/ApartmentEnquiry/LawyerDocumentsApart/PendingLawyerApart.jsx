...
const PendingLawyerApart = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/apart_lawyer_documents/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
...
export default PendingLawyerApart;
