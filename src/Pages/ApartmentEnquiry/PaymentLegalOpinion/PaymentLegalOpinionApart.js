...
import WaitingLegalApart from "./WaitingLegalApart";
import PendingLegalApart from "./PendingLegalApart";
import CompleteLegalApart from "./CompleteLegalApart";

const PaymentLegalOpinionApart = () => {
...
export default PaymentLegalOpinionApart