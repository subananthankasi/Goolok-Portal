...
const PendingLegalApart = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/apart_payment_legal_opinion/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
...
export default PendingLegalApart;
