...
const PendingContentWritingApart = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/apart_content_Writing/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("pending")}`);
    };
...
export default PendingContentWritingApart