...
const ProjectDetailsContentApart = ({ eid, id, status, pagetype }) => {
    ...
    const handleEdit = (row) => {
        ...
        formik.setFieldValue("frontage", row.road_frontage)
        formik.setFieldValue("roadwidth", row.road_width)
        formik.setFieldValue("cornerproperty", row.corner_property)
    ...
    const fetchDetails = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/apartagreement/${eid}`, {
            })
    ...
    const formik = useFormik({
        ...
        validationSchema: yup.object().shape({
            ...
            landarea: yup.string().required("total land area is required !!"),
            ...
            parkingcost: yup.string().required("parkingcost is required !!"),
            total_apart_cost: yup.string().required("total_apart_cost is required !!"),
            // file: yup
            //     .mixed()
                        ...
                        </div>
                        {
                            prDetails?.length === 0 ? (
                                <div className="d-flex justify-content-center">
                                    <button className="btn1" onClick={() => setNewDialog(true)}>+Create Agreement</button>
                                </div>
                            ) : (
                                <DataTable
                            ...
                            <div className="row">
                                ...
                                <div className="col-8 mb-3 ">
                                    ...
                                    >
                                        ...
                                        {pincodeData?.filter((pin) => pin.pin_village === formik.values.village).map((item) => (
                        ...
                        <div className="col-md-6 mb-3 ">
                            <div className="row">
                                ...
                                <div className="col-8 mb-3 ">
                                    ...
                                    {formik.errors.total_apart_cost && formik.touched.total_apart_cost ? (
                                        <p style={{ color: "red", fontSize: "12px" }}>
                        ...
                        <div className="col-md-6 mb-3 ">
                            <div className="row">
                                ...
                                <div className="col-8 mb-3 ">
                                    ...
                                    {formik.errors.frontage && formik.touched.frontage ? (
                                        <p style={{ color: "red", fontSize: "12px" }}>
                                            {formik.errors.frontage}
                                        </p>
                                    ) : null}
                                </div>
                            </div>
                        ...
                        <div className="col-md-6 mb-3 ">
                            <div className="row">
                                ...
                                <div className="col-8 mb-3 ">
                                    ...
                                    {formik.errors.cornerproperty && formik.touched.cornerproperty ? (
                                        <p style={{ color: "red", fontSize: "12px" }}>
...
export default ProjectDetailsContentApart
