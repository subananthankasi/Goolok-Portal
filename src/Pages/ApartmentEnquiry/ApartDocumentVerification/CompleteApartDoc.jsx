...
function CompleteApartDoc() {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/updateDocApart/${encryptData(rowData.id)}/${encryptData(rowData.userid)}/${encryptData("complete")}`);
  };
...
export default CompleteApartDoc;
