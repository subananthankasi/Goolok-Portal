...
import WaitingDocApart from './WaitingDocApart';
import PendingApartDoc from './PendingApartDoc';
import CompleteApartDoc from './CompleteApartDoc';

const ApartDocumentVerification = () => {
...
export default ApartDocumentVerification