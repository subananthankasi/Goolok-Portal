...
import AddMoreApart from "./AddMoreApart";
...
const WholeComponentDocApart = ({ eid, id, status, pagetype }) => {
      ...
      >
        <form action="" onSubmit={formik.handleSubmit}>
          ...
          <div className="d-flex justify-content-end mt-3">
            <button className="btn1" type="submit" disabled={docLoading}>
                ...
                <TabPanel header="Project Details">
                  <div className="row">
                    <div className="col-6">
                      ...
                      <div className=" row mt-5">
                        <div className="col-6"> No of BHK :</div>
                        <div className="col-6">{projectData?.bhk_count}</div>
                      </div>
                      <div className=" row mt-5">
                        <div className="col-6">Floor:</div>
                        <div className="col-6">{projectData?.floor}</div>
                      </div>

                      <div className=" row mt-5 mb-5">
                        <div className="col-6"> Common Area (units) :</div>
                    ...
                    <div className="col-6">
                      <div className="row mt-5">
                        <div className="col-6">DTCP / CMDA Approval No. :</div>
                      ...
                      <div className=" row mt-5">
                        <div className="col-6">Apartment No. :</div>
                        <div className="col-6">{projectData?.apartment_no}</div>
                      </div>
                      <div className=" row mt-5">
                        <div className="col-6"> Facing :</div>
                        <div className="col-6">{projectData?.facing}</div>
                      </div>
                      <div className=" row mt-5">
                        <div className="col-6">Built up area (units) :</div>
                      ...
                      <div className=" row mt-5 mb-5">
                        ...
                        <div className="col-6">{projectData?.parking}</div>
                      </div>
                    </div>
                  </div>
                </TabPanel>
...
export default WholeComponentDocApart;
