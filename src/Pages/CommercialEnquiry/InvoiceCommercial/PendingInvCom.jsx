...
function PendingInvCom() {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/commercial_invoice/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData(rowData.status)}`);
  };
