...
const PendingFieldCom = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/commercial_fieldsurvey/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}/${encryptData(rowData.subpro_name)}`);
  };
...
export default PendingFieldCom;
