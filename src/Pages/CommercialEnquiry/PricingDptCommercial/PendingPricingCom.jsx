...
const PendingPricingCom = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/commercial_pricing/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("pending")}/${encryptData(rowData.subpro_name)}`);
    };
...
export default PendingPricingCom