              ...
              >
                ...
                >
                  <Column width={130} colSpan={2}>
                    ...
                    <Cell>{(rowData) => rowData.basic_cost? `₹${rowData.basic_cost}` : "-"}</Cell>
                  </Column>
                  <Column width={160}>
                    <HeaderCell>Development charges </HeaderCell>
                    <Cell>{(rowData) => rowData.development_charges? `₹${rowData.development_charges}` : "-"}</Cell>

                  </Column>
                  <Column width={160}>
                    <HeaderCell>Infrastructure cost </HeaderCell>
                     <Cell>{(rowData) => rowData.infrastructure_cost? `₹${rowData.infrastructure_cost}` : "-"}</Cell>

                  </Column>
                  <Column width={130}>
                    <HeaderCell>Total </HeaderCell>
                     <Cell>{(rowData) => rowData.plot_cost_total? `₹${rowData.plot_cost_total}` : "-"}</Cell>
                ...
                >
                  <Column width={130} colSpan={2}>
                    <HeaderCell>Corpus Amount</HeaderCell>
                     <Cell>{(rowData) => rowData.corpus_amount? `₹${rowData.corpus_amount}` : "-"}</Cell>

                  </Column>
                  <Column width={160}>
                    <HeaderCell>Maintenance Amount </HeaderCell>
                     <Cell>{(rowData) => rowData.maintenance_amount? `₹${rowData.maintenance_amount}` : "-"}</Cell>


                  </Column>
                  <Column width={160}>
                    <HeaderCell>Miscellaneous charges </HeaderCell>
                     <Cell>{(rowData) => rowData.misc_charges? `₹${rowData.misc_charges}` : "-"}</Cell>


                  </Column>
                  <Column width={130}>
                    <HeaderCell>GST </HeaderCell>
                     <Cell>{(rowData) => rowData.gst_amount? `₹${rowData.gst_amount}` : "-"}</Cell>


                  </Column>
                  <Column width={130}>
                    <HeaderCell>Total </HeaderCell>
                     <Cell>{(rowData) => rowData.association_cost_total? `₹${rowData.association_cost_total}` : "-"}</Cell>
                ...
                >
                  <Column width={160} colSpan={2}>
                    <HeaderCell>Registration Charges</HeaderCell>
                     <Cell>{(rowData) => rowData.registration_charges? `₹${rowData.registration_charges}` : "-"}</Cell>


                  </Column>
                  <Column width={170}>
                    <HeaderCell>Documentation charges </HeaderCell>
                     <Cell>{(rowData) => rowData.documentation_charges? `₹${rowData.documentation_charges}` : "-"}</Cell>


                  </Column>
                  <Column width={130}>
                    <HeaderCell>Total </HeaderCell>
                     <Cell>{(rowData) => rowData.registration_total? `₹${rowData.registration_total}` : "-"}</Cell>
                ...
                >
                  <Column width={160} colSpan={2}>
                    <HeaderCell>Without Registration</HeaderCell>
                     <Cell>{(rowData) => rowData.total_without_registration? `₹${rowData.total_without_registration}` : "-"}</Cell>


                  </Column>
                  <Column width={160}>
                    <HeaderCell>With Registration </HeaderCell>
                     <Cell>{(rowData) => rowData.total_with_registration? `₹${rowData.total_with_registration}` : "-"}</Cell>
