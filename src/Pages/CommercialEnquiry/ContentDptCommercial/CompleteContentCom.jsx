...
const CompleteContentCom = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/commercial_contentwriting/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("complete")}/${encryptData(rowData.subpro_name)}`);
...
export default CompleteContentCom;
