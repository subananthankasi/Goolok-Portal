...
const PendingContentCom = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/commercial_contentwriting/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("pending")}/${encryptData(rowData.subpro_name)}`);
    };
...
export default PendingContentCom