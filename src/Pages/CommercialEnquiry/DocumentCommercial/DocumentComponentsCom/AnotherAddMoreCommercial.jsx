...
const AnotherAddMoreCommercial = ({ isOpen, closeModal, data }) => {
    ...
    const validate = () => {
        ...
        fetchData.forEach((item) => {
            if (!formData[item.documentsub] || formData[item.documentsub].trim() === "") {
                                                ...
                                                {staffid.Login === "staff" ?
                                                    <div className="row">
                                                        ...
                                                        <div className="text-end">
                                                            {staffid.Login === "staff" && (data.status === "pending" || data.status === "complete") && (
                                                                <>
                                                        ...
                                                        {fetchData?.map((item, index) => (
                                                            <div className="col-md-6 mb-3" key={index}>
                                                                <div className="row">
                                                                    ...
                                                                    <div className="col-8 mb-3">
                                                                        <label className="form-label">{formData[item.documentsub] || ""}</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ))}
...
export default AnotherAddMoreCommercial