...
import AddMoreCommercial from "./AddMoreCommercial";
import AnotherAddMoreCommercial from "./AnotherAddMoreCommercial";

const WholeDocCommercial = ({ eid, id, status, pagetype }) => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      navigate("/commercial_document#Complete");
    } catch (error) {
      const errorMessage =
...
export default WholeDocCommercial;
