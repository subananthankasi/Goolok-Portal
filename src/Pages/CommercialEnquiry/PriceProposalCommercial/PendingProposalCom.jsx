...
function PendingProposalCom() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/proposal?id=${staffid.loginid}&status=pending`, {
                headers: {
                    "Pr-Root": "commercial"
                }
            });
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/commercial_priceproposal/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}/${encryptData(rowData.subpro_name)}`);
    };
                        ...
                        {loading ? (
                            ...
                            <div className="col-12">
                                <div className="card-body p-1">
                                    <h4 className="page_heading">Pending Proposal Report</h4>
...
export default PendingProposalCom;
