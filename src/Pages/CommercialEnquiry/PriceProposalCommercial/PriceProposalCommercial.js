...
import WaitingProposalCom from "./WaitingProposalCom";
import PendingProposalCom from "./PendingProposalCom";
import CompleteProposalCom from "./CompleteProposalCom";

const PriceProposalCommercial = () => {
...
export default PriceProposalCommercial