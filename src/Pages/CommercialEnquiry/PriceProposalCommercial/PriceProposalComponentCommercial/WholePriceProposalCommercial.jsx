...
export const WholePriceProposalCommercial = ({ eid, id, status, pagetype }) => {
                ...
                cell: (row) => (
                    <div className="d-flex">
                        <button
                            ...
                            data-tooltip-id="delete" onClick={() => { setIsModalPriceproposalEdit(true); setEditData(row) }}
                        >
                            <EditIcon />
                        </button>
                    </div>
    ...
    return (
        <>
            ...
            {loading ? "" : <div className="col-12 mt-4">
                <div className="card shadow border-0">
                    <div className="card shadow border-0 p-4">
                        ...
                        {proposalData.length === 0 && staffid.logintype === "staff" ? <div className="container" style={{ maxWidth: "350px" }}>
...
const PriceproposalAgreement = ({ isOpen, closeModal, eid, id, fetch }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setloading(true)
        try {
            await axios.post(`${API_BASE_URL}/proposal`, formData, {
                    ...
                    <div className="modal-content">
                        <div className="d-flex" style={{ alignItems: "center" }}>
                            ...
                            <button
                                ...
                                onClick={() => { closeModal(); handleClear() }}
                            >
                                    ...
                                    <div className="col-12 mb-3">
                                        <div className="row">
                                            ...
                                            <div className="col-7">
                                                ...
                                                />
                                                {errors.totalPrice && (
                                                    <div className="validation_msg">{errors.totalPrice}</div>
                                                )}
                                            </div>
                                        </div>
                                    </div>
...
const PriceproposalEdit = ({ isOpen, closeModal, fetch, editData }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setloading(true)
        try {
            await axios.post(`${API_BASE_URL}/proposalup`, formData, {
                headers: { "Content-Type": "multipart/form-data" },
            });
            Toast({ message: "Added successfully", type: "success" });
            closeModal();
                                            ...
                                            <div className="col-7">
                                                <div className="d-flex">
                                                    ...
                                                    <a
                                                        ...
                                                        className="btn btn-warning ms-1 text-end"
                                                        download="download"
                                                        target="_blank"
                                                        rel="noopener noreferrer"
                                                    >
