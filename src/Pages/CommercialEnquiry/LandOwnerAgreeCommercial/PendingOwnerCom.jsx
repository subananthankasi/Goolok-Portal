...
const PendingOwnerCom = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/commercial_landowneragreement/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}/${encryptData(rowData.subpro_name)}`);
  };
...
export default PendingOwnerCom;
