...
import WaitingOwnerCom from "./WaitingOwnerCom";
import PendingOwnerCom from "./PendingOwnerCom";
import CompleteOwnerCom from "./CompleteOwnerCom";


const LandOwnerComercial = () => {
...
export default LandOwnerComercial