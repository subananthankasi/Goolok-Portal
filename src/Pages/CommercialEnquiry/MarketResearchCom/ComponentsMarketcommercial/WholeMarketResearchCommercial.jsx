...
import CustomerMarketCom from "./CustomerMarketCom";
import NearbyMarketCom from "./NearbyMarketCom";
import { useSelector } from "react-redux";

export const WholeMarketResearchCommercial = ({
  eid,
  marketid,
  status,
  subtype,
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      navigate("/commercial_marketresearch#Complete");
    } catch (error) {
      const errorMessage =
