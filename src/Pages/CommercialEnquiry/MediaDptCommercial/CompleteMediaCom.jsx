...
const CompleteMediaCom = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/commercial_media/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("complete")}/${encryptData(rowData.subpro_name)}`);
    };
    return (
        <>
...
export default CompleteMediaCom