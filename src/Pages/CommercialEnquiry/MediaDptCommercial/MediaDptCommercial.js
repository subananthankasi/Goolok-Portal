...
import WaitingMediaCom from "./WaitingMediaCom";
import PendingMediaCom from "./PendingMediaCom";
import CompleteMediaCom from "./CompleteMediaCom";

const MediaDptCommercial = () => {
...
export default MediaDptCommercial