...
const PendingMediaCom = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/commercial_media/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("pending")}/${encryptData(rowData.subpro_name)}`);
    };
...
export default PendingMediaCom