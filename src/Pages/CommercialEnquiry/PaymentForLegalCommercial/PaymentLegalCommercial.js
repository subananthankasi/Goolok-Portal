...
import WaitingPaymentCom from "./WaitingPaymentCom";
import PendingPaymentCom from "./PendingPaymentCom";
import CompletePaymentCom from "./CompletePaymentCom";



const PaymentLegalCommercial = () => {
...
export default PaymentLegalCommercial