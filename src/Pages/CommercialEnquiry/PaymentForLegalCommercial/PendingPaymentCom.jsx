...
const PendingPaymentCom = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/commercial_paymentlegalopinion/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}/${encryptData(rowData.subpro_name)}`);
    };
                        ...
                        {loading ? (
                            ...
                            <div className="col-12">
                                <div className="card-body p-1">
                                    <h4 className="page_heading">Pending Legal Opinion Report</h4>
...
export default PendingPaymentCom;
