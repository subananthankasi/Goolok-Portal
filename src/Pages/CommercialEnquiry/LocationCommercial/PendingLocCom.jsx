...
function PendingLocCom() {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/commercial_location/${encryptData(rowData.enqry_id)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
