...
const PendingLawyerCom = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(
      `/commercial_lawyerdocument/${encryptData(rowData.enqid)}/${encryptData(
        rowData.id
      )}/${encryptData("pending")}/${encryptData(rowData.subpro_name)}`
    );
  };
...
export default PendingLawyerCom;
