...
const CompleteLawyerCom = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/commercial_lawyerdocument/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('complete')}/${encryptData(rowData.subpro_name)}`);
    };
...
export default CompleteLawyerCom;
