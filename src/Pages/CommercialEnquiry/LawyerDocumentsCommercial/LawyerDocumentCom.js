...
import WaitingLawyerCom from "./WaitingLawyerCom";
import PendingLawyerCom from "./PendingLawyerCom";
import CompleteLawyerCom from "./CompleteLawyerCom";

const LawyerDocumentCom = () => {
...
export default LawyerDocumentCom;
