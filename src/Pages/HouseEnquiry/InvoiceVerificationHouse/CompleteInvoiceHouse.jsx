...
const CompleteInvoiceHouse = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/invoice_house/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData(rowData.status)}`);
    };
...
export default CompleteInvoiceHouse