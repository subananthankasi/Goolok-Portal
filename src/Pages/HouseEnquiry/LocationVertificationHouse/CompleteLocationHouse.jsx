...
const CompleteLocationHouse = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/house_location/${encryptData(rowData.enqry_id)}/${encryptData(rowData.id)}/${encryptData('complete')}`);
  };
  return (
    <>
...
export default CompleteLocationHouse