...
const PendingMarketHouse = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/house_marketresearch/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("pending")}`);
    };
...
export default PendingMarketHouse