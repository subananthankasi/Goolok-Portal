...
const CompleteLawyerHouse = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/house_lawyerdocument/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('complete')}/${encryptData(rowData.subpro_name)}`);
    };
...
export default CompleteLawyerHouse;
