...
const PendingLawyerHouse = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/house_lawyerdocument/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}/${encryptData(rowData.subpro_name)}`);
    };
...
export default PendingLawyerHouse;
