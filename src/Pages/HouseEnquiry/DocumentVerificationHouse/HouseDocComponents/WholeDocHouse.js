...
import AddMoreHouse from "./AddMoreHouse";
...
const WholeDocHouse = ({ eid, id, status, pagetype }) => {
  ...
  const fetchTitleVillaDetails = async (eid) => {
    try {
      // const response = await axios.get(`${API_BASE_URL}/prdetail/${eid}`);
  ...
  useEffect(() => {
    if (viewData?.id && viewData.doc_type === "Patta") {
      ...
      fetchTitleVillaDetails(viewData?.eid);
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      navigate("/house_document#Complete");
          ...
          <div className="form-group">
            ...
            >
              ...
              {selectOptions?.map((item) => (
                <option value={item.id} key={item.id}>{item.document} </option>
              ))}
            </select>
        ...
        {viewData?.upload_type === "document" ? (
          ...
          <>
            <TabView>
                ...
                <TabPanel header="Project Details">
                  <div className="row">
                    <div className="col-6">
                      ...
                      <div className="row mt-5">
                        <div className="col-6">Villa No :</div>
                        <div className="col-6">{projectData?.plot_no}</div>
                      </div>
                      <div className=" row mt-5">
                      ...
                      <div className=" row mt-5">
                        <div className="col-6">RERA No:</div>
                        <div className="col-6">{projectData?.rera_no}</div>
                      </div>

                      <div className=" row mt-5 mb-5">
                        <div className="col-6"> Building Permit No :</div>
                        <div className="col-6">
                          {projectData?.building_permit_no}
                        </div>
                      </div>
                    </div>
                    <div className="col-6">
                      ...
                      <div className="row mt-5">
                        <div className="col-6">Common Area:</div>
                        <div className="col-6">{projectData?.common_area}</div>
                      </div>
                      <div className=" row mt-5">
                        <div className="col-6">Supper Built Up Area :</div>
                        <div className="col-6">{projectData?.super_area}</div>
                      </div>
                      <div className=" row mt-5 mb-5">
                        <div className="col-6"> Planning Permit No :</div>
                        <div className="col-6">
                          {projectData?.planing_permit_no}
                        </div>
                      </div>
                      <div className=" row mt-5">
                        <div className="col-6"> Uds :</div>
                        <div className="col-6">{projectData?.uds_size}</div>
                      </div>
                    </div>
                  </div>
                </TabPanel>
              ...
              {viewData?.doc_type === "Title document" && (
                <TabPanel header="Villa Details">
                  <div className="row">
                    <div className="col-6">
                      <div className="row mt-5">
                        <div className="col-6">House Type :</div>
                        <div className="col-6">{villaDetails?.housetype}</div>
                      </div>

                      <div className=" row mt-5">
                        <div className="col-6">Door Facing :</div>
                        <div className="col-6">
                          {villaDetails?.door_facing}
                        </div>
                      </div>
                      <div className=" row mt-5">
                        <div className="col-6"> No. of Bedrooms :</div>
                        <div className="col-6">{villaDetails?.no_bedrooms}</div>
                      </div>

                      <div className=" row mt-5 mb-5">
                        <div className="col-6"> No of Balcony :</div>
                        <div className="col-6">
                          {villaDetails?.no_balcony}
                        </div>
                      </div>
                    </div>
                    <div className="col-6">
                      <div className="row mt-5">
                        <div className="col-6">Car Parking :</div>
                        <div className="col-6">{villaDetails?.carparking}</div>
                      </div>
                      <div className="row mt-5">
                        <div className="col-6">No Of Floors :</div>
                        <div className="col-6">{villaDetails?.no_floors}</div>
                      </div>
                      <div className=" row mt-5">
                        <div className="col-6">No of Bathrooms :</div>
                        <div className="col-6">{villaDetails?.no_bathrooms}</div>
                      </div>
                    </div>
                  </div>
                </TabPanel>
