...
const PendingPricingDptHouse = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/house_pricing/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("pending")}/${encryptData(rowData.subpro_name)}`);
    };
...
export default PendingPricingDptHouse