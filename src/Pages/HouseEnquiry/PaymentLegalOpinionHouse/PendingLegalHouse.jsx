...
const PendingLegalHouse = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/house_paymentlegalopinion/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
...
export default PendingLegalHouse;
