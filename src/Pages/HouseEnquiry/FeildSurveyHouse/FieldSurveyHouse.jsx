...
import WaitingFieldSurveyHouse from "./WaitingFieldSurveyHouse";
import PendingFieldSurveyHouse from "./PendingFieldSurveyHouse";
import CompleteFieldSurveyHouse from "./CompleteFieldSurveyHouse";
            ...
            <div className="col-12">
              <div className="card">
                ...
                <div className="card-b ody">
                  ...
                  {step === 2 && (
                    <>
                      <PendingFieldSurveyHouse />

                    </>
                  )}
                  {step === 3 && (
                    <>
                      <CompleteFieldSurveyHouse />
...
export default FieldSurveyHouse;
