...
const PendingContentHouse = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/house_contentwriting/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("pending")}/${encryptData(rowData.subpro_name)}`);
    };
...
export default PendingContentHouse