...
function PendingProposalHouse() {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/house_priceproposal/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
...
export default PendingProposalHouse;
