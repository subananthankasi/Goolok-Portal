...
const PromotionBanner3 = () => {
  ...
  return (
    <>
          ...
          <div className="card">
            <div className="card-header">
              <div className="d-flex justify-content-between">
                <h4 className="page_heading">PromotionBanner3 View Table</h4>
      ...
      >
        <Modal.Header>
          <Modal.Title>PromotionBanner3 </Modal.Title>
        </Modal.Header>
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="mb-3">
              <label htmlFor="image" className="form-label">
                Banner Image{" "}
                <span className="mx-1">
                  {formik.values.device === "web" ? "(1920x550)" : "(1440x732)"}{" "}
                </span>
              </label>
...
export default PromotionBanner3;
