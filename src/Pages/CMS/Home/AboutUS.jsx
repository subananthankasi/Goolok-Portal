...
const AboutUS = () => {
    ...
    const handlePreview = (row) => {
        setPreview(true)
        const url = `${IMG_PATH}/cms/aboutus/${row.image}`
        setPreviwUrl(url)
    }
            ...
            cell: (row) => (
                row.image ? (
                    <div onClick={() => handlePreview(row)} style={{ cursor: "pointer" }}>
                        <img
                            src={`${IMG_PATH}/cms/aboutus/${row.image}`}
                            alt={row.title}
    ...
    const handleEdit = (row) => {
        ...
        formik.setFieldValue("subcontent", row.subcontent || "");
    ...
    const formik = useFormik({
        ...
        //   subcontent: yup.string().required("subcontent is required!"),
    ...
    const handleconfirmopendelete = async () => {
        ...
        try {
            await axios.delete(`${API_BASE_URL}/aboutus/${selectedRowId}`);
            fetchRoles()
    ...
    return (
        <>
            ...
            >
                <Modal.Header>
                    <Modal.Title>AboutUs </Modal.Title>
                </Modal.Header>
                ...
                >
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <div className='col-12 mb-3'>
                            ...
                            <div className="">
                                <label htmlFor="content" className='form-label text-muted'>Content</label>
                        ...
                        <div className='col-12 mb-3'>
                            ...
                            <div className="">
                                <label htmlFor="subcontent" className='form-label text-muted'>Subsubcontent</label>

                                <Editor
                                    id="subcontent"
                                    name="subcontent"
                                    value={formik.values.subcontent}
                                    onTextChange={(e) => formik.setFieldValue("subcontent", e.htmlValue)}
                                    onBlur={formik.handleBlur}
                                    style={{ height: "320px" }}
                                />
                                {formik.errors.subcontent && formik.touched.subcontent && (
                                    <p style={{ color: "red", fontSize: "12px" }}>
                                        {formik.errors.subcontent}
                                    </p>
                                )}
