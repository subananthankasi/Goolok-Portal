...
const AdBlock2 = () => {
  ...
  return (
    <>
          ...
          <div className="card">
            <div className="card-header">
              <div className="d-flex justify-content-between">
                <h4 className="page_heading">Add Block-2 Reports</h4>
      ...
      >
        <Modal.Header>
          <Modal.Title>Add Block-2 </Modal.Title>
        </Modal.Header>
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            {formik.values.device === "web" && (
              <div className="mt-2 mb-2">
                ...
                >
                  ...
                  <option value="320">320 x 70 px - Small Mobile</option>
                  <option value="375">375 x 70 px - Mobile</option>
                  <option value="425">425 x 70 px - Large Mobile</option>
                  <option value="768">768 x 80 px - Tablet</option>
                  <option value="1024">1024 x 90 px - Small Desktop</option>
                  <option value="desktop">
                    {" "}
                    Desktop (Above 1024 x 120 px )
                  </option>
                </select>
            ...
            <div className="mb-3">
              <label htmlFor="image" className="form-label">
                Banner Image{" "}
                <span className="mx-1">
                  {formik.values.device === "app" && "(1440x220)"}{" "}
                </span>
              </label>
