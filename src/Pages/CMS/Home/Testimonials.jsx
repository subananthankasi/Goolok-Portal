...
const Testimonials = () => {
            ...
            cell: (row) => (
                row.image ? (
                    <div onClick={() => handlePreview(row)} style={{ cursor: "pointer" }}>
                        <img
                            src={`${IMG_PATH}/cms/testimonials/${row.image}`}
                            alt={row.title}
    ...
    const handleEdit = (row) => {
        ...
        formik.setFieldValue("place", row.place || "");
        formik.setFieldValue("content", row.content || "");
        formik.setFieldValue("image", row.image || "");
        setPreviewImage(`${IMG_PATH}/cms/testimonials/${row.image}`);
    ...
    const onSubmit = async (values) => {
        ...
        try {
            const response = await axios.post(`${API_BASE_URL}/testimonials`, values, {
    ...
    const handleconfirmopendelete = async () => {
        ...
        try {
            await axios.delete(`${API_BASE_URL}/testimonials/${selectedRowId}`);
            fetch()
                    ...
                    <div className="card">
                        <div className="card-header">
                            <div className="d-flex justify-content-between">
                                <h4 className="page_heading">Testimonials Reports</h4>
            ...
            >
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className="mb-2">
                        ...
                        />
                        {previewImage && (
                            <button type='button' className='btn btn-sm btn-secondary mt-1' onClick={handlePreviewImage}>Preview</button>
                        )}
