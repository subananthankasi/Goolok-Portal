...
const Block2 = () => {
  ...
  const handlePreview = (row) => {
    setPreview(true)
    const url = `${IMG_PATH}/cms_service/blocksection/${row.image}`
    setPreviwUrl(url)
  }
  ...
  const onSubmit = async (values) => {
    ...
    try {
      const response = await axios.post(`${API_BASE_URL}/blocksection`, values, {
  ...
  return (
    <>
          ...
          <div className="card">
            <div className="card-header">
              <div className="d-flex justify-content-between">
                <h4 className="page_heading">Service block2 View Table</h4>
      ...
      >
        <Modal.Header>
          <Modal.Title> Service block2 Banner Image </Modal.Title>
        </Modal.Header>
