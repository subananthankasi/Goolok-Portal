...
const ServiceName = () => {
  ...
  const fetchRoles = async () => {
    try {
      const response = await axios.get(`${API_BASE_URL}/servicenameviewall`, {
      });
  ...
  const onSubmit = async (values) => {
    ...
    try {
      const response = await axios.post(`${API_BASE_URL}/servicename`, values, {
  ...
  const handleconfirmopendelete = async () => {
    ...
    try {
      await axios.delete(`${API_BASE_URL}/servicename/${selectedRowId}`);
      fetchRoles()
          ...
          <div className="card">
            <div className="card-header">
              <div className="d-flex justify-content-between">
                <h4 className="page_heading">Service ServiceName View Table</h4>
                <button
                  type="button"
                  className="btn1"
                  onClick={() => {
