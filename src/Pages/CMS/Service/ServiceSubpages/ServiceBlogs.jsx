...
//                 <h4 className="page_heading">Blogs View Table</h4>
//                 <button
//                   type="button"
//                   className="btn1"
//                   onClick={() => {
...
import React from "react";
import MainBanner from "./BlogComponents/MainBanner";
import Blogs from "./BlogComponents/Blogs";
import MostReadBlogs from "./BlogComponents/MostReadBlogs";
import SourceLinks from "./BlogComponents/SourceLinks";


const ServiceBlogs = ({ eid, id, status }) => {
