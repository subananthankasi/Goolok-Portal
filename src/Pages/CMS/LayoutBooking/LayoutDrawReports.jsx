...
const LayoutDrawReports = () => {
    ...
    function gridUrlTemplate(props) {
        return (
            <Link
                to={`/layoutdrawrpreview/${encryptData(props.id)}`
                }
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${API_BASE_URL}/drawlayoutbooking`);
                            ...
                            <div className="col-12">
                                <div className="card">
                                    <div className="card-body">
                                        <h4 className="page_heading">Layout Drawing Reports</h4>
                                        <div className="col-lg-12  mb-4 mt-4">
                                            ...
                                            >
                                                <ColumnsDirective>
                                                    ...
                                                    <ColumnDirective field='enqid' headerText='Property ID' width='150' template={ProjectID} />
                                                    <ColumnDirective field='plotno' headerText='Plot No' width='170' />
                                                    ...
                                                    <ColumnDirective
                                                        ...
                                                        width="170"
                                                    />
                                                    <ColumnDirective field='subproperty_name' headerText='Sub Property Type' width='180' />
...
export default LayoutDrawReports
