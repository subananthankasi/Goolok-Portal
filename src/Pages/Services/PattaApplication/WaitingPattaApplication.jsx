...
const WaitingPattaApplication = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/pattaApp/new`, {
                headers: {
                    "Pr-Root": "land",
                    "Level": "service",
    ...
    const handleConfirm = async () => {
        ...
        try {
            await axios.put(`${API_BASE_URL}/pattaApp/${docId}`, updateData, {
                headers: {
...
export default WaitingPattaApplication