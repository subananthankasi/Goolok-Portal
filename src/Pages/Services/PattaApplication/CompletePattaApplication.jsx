...
const CompletePattaApplication = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${API_BASE_URL}/pattaApp?id=${staffid.loginid}&status=complete`, {
                    headers: {
                        "Pr-Root": "land",
                        "Level": "service",
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/update_application/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('complete')}`);
    };
...
export default CompletePattaApplication