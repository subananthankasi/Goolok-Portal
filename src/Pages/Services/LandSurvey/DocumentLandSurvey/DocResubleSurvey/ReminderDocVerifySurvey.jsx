...
import AddMoreDocViewSurvey from "./AddMoreDocViewSurvey";
import AddMoreViewSurvey from "./AddMoreViewSurvey";
import AddMoreSurvey from "./AddMoreSurvey";
import AddMoreDocDetSurvey from "./AddMoreDocDetSurvey";
import customStyle from "../../../../../Utils/tableStyle";
import Toast from "../../../../../Utils/Toast";


const ReminderDocVerifySurvey = ({ eid, status, pagetype }) => {
    ...
    const columns = [
        ...
        // },
        {
            ...
            cell: (row) => {
                ...
                return (
                    <>
                        {staffid.logintype === "staff" && enquiryDoumentData?.status !== "live" && pagetype !== "reminder" ? (
                            <button
                                type="button"
                                className="btn btn-primary rounded-0"
                                onClick={handleClick}
...
export default ReminderDocVerifySurvey
