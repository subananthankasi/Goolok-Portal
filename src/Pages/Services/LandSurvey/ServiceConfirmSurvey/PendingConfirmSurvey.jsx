...
const PendingConfirmSurvey = () => {
  ...
  //   try {
  //     const response = await axios.get(`${API_BASE_URL}/confirmation?id=${staffid.loginid}&status=pending`, {
  //       headers: {
  //         "Pr-Root": "land",
  //         "Level": "service",
  ...
  const fetchData = useCallback(async () => {
    try {
      const response = await axios.get(
        `${API_BASE_URL}/confirmation?id=${staffid.loginid}&status=pending`,
        {
          headers: {
            "Pr-Root": "land",
            "Level": "service",
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/update_confirm_survey/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
...
export default PendingConfirmSurvey