...
const WaitingConfirmSurvey = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`${API_BASE_URL}/confirmation/new`, {
        headers: {
          "Pr-Root": "land",
          "Level": "service",
  ...
  const handleConfirm = async () => {
    ...
    try {
      await axios.put(`${API_BASE_URL}/confirmation/${docId}`, updateData, {
        headers: {
...
export default WaitingConfirmSurvey