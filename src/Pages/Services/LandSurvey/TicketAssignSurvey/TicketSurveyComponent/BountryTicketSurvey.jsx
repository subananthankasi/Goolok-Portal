...
const BountryTicketSurvey = ({ eid, id, status, pagetype }) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object().shape({
      ...
      verifystatus: yup.string().required("verifystatus  is required!"),
      dispute: yup.string().required("dispute type is required!"),
      nextfollowdate: yup.string().required("nextfollowdate  is required!"),
  ...
  const handleEdit = (item) => {
    ...
    formik.setFieldValue("verifystatus", landDetails.verifystatus || "");
    formik.setFieldValue("dispute", landDetails.dispute || "");
    formik.setFieldValue("nextfollowdate", landDetails.nextfollowdate || "");
              ...
              >
                <thead>
                  <tr className="text-center">
                    ...
                    <th className="landowner_enq_th_1">Verification Status</th>
                    <th className="landowner_enq_th_1">Dispute</th>
                    <th className="landowner_enq_th_1">Next Follow Up Date</th>
                  ...
                  <tr className="text-center">
                    <th colSpan="7" className="landowner_enq_th"></th>
                  ...
                  {getData?.map((item, index) => {
                    ...
                    return (
                      <tr key={index} className="text-center">
                        ...
                        <td>{landDetails.verifystatus} </td>
                        <td>{landDetails.dispute} </td>
                        <td>{landDetails.nextfollowdate} </td>
          ...
          <div className="row">
            ...
            <div className="form-group mt-2 col-6">
              ...
              <input
                ...
                name="verifystatus"
                className="form-control"
                value={formik.values.verifystatus}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
                placeholder="Enter verify status..."
              />

              {formik.errors.verifystatus && formik.touched.verifystatus ? (
                <p style={{ color: "red", fontSize: "12px" }}>
                  {formik.errors.verifystatus}
                </p>
              ) : null}
            </div>
          </div>
          <div className="row">
            ...
            <div className="form-group mt-2 col-6">
              ...
              <input
                ...
                name="nextfollowdate"
                className="form-control"
                value={formik.values.nextfollowdate}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
              />

              {formik.errors.nextfollowdate && formik.touched.nextfollowdate ? (
                <p style={{ color: "red", fontSize: "12px" }}>
                  {formik.errors.nextfollowdate}
                </p>
              ) : null}
            </div>
          </div>
...
export default BountryTicketSurvey;
