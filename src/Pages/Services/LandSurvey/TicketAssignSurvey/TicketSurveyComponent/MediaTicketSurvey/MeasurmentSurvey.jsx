...
const MeasurmentSurvey = ({ eid, id, status, pagetype }) => {
  ...
  return (
    <>
      ...
      <Dialog
        ...
        // }}
        onHide={() => {
          if (!postLoading) setNewDialog(false);
          formik.resetForm();
        }}
      ...
      <Dialog
        ...
        // }}
        onHide={() => {
          if (!postLoading) setEditDialog(false);
          formik.resetForm();
        }}
        closable={!postLoading}
      >
...
export default MeasurmentSurvey;
