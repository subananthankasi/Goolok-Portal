...
const PendingTicketSurvey = () => {
    ...
    //     try {
    //         const response = await axios.get(`${API_BASE_URL}/servicehub?id=${staffid.loginid}&status=pending`, {
    //             headers: {
    //                 "Pr-Root": "land",
    //                 "Level": "service",
    ...
    const fetchData = useCallback(async () => {
        try {
            const response = await axios.get(
                `${API_BASE_URL}/servicehub?id=${staffid.loginid}&status=pending`,
                {
                    headers: {
                        "Pr-Root": "land",
                        "Level": "service",
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/update_ticket_assigning_hub/${rowData.enqid}/${rowData.id}/${'pending'}`);
...
export default PendingTicketSurvey