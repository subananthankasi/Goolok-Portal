...
// import { contactPersonGetThunk } from "../../../../Redux/Actions/MasterPage/ContactPersonTalukThunk";
...
const TalukDetailsSurvey = ({ eid, id, status, rowId, pagetype }) => {
    ...
    const talukOfficeData = useSelector((state) => state.talukDetailsData.get.data)
    ...
    const onSubmit = async (values) => {
        ...
        setPostLoading(true)
        try {
            const response = await axios.post(`${API_BASE_URL}/officecreate`, payload)
            fetchWholeData()
            formik.resetForm()
    ...
    const handleDelete = async (row) => {
        try {
            const response = await axios.delete(`${API_BASE_URL}/officedelete/${deleteId}`)
    ...
    const handleEdit = (row) => {
        ...
        const parseSroPersonNo = row.sromobnumber ? JSON.parse(row.sromobnumber) : [];
    ...
    const formik = useFormik({
        ...
        validationSchema: yup.object({
            ...
            talukOffice: yup.string().required('Taluk Office is required'),
    ...
    const fetchTalukContactPersonNo = async (talukOfficeId) => {
        try {
            const response = await axios.get(`${API_BASE_URL}/contactPerson/${talukOfficeId}`, {
                headers: {
                    "Pr-Root": "taluk"
                }
            })
    ...
    const fetchTalukContactPersonName = async (talukOfficeId) => {
        try {
            setLoading(true);
            const response = await axios.get(`${API_BASE_URL}/contactPerson/${talukOfficeId}/edit`, {
                headers: {
                    "Pr-Root": "taluk"
                }
            });
                            ...
                            <div className="row">
                                <div className="col-6">
                                    <div className="form-group ">
                                        <label className="form-label"> Taluk Office : <span style={{ color: "red" }}>*</span> </label>
                                        <select
                                            type="text"
                                            className="form-select"
                                            name="talukOffice"
                                        ...
                                        >
                                            ...
                                            {talukOfficeData?.filter((taluk) => taluk.talukname === formik.values.taluk).map((item) => (
                                    ...
                                    <div className="form-group mt-3">
                                        ...
                                        {formik.errors.talukPersonName && formik.touched.talukPersonName ? (
                                            <p style={{ color: "red", fontSize: "12px" }}>
                                    ...
                                    <div className="form-group mt-3">
                                        ...
                                        {formik.errors.talukPersonNo && formik.touched.talukPersonNo ? (
                                            <p style={{ color: "red", fontSize: "12px" }}>
                                ...
                                <div className="col-6">
                                    <div className="form-group ">
                                        ...
                                        >
                                            ...
                                            {SRODetailsData?.filter((taluk) => taluk.sro_taluk === formik.values.taluk).map((item) => (
                                    ...
                                    <div className="form-group mt-3">
                                        ...
                                        {formik.errors.sroPersonName && formik.touched.sroPersonName ? (
                                            <p style={{ color: "red", fontSize: "12px" }}>
                                    ...
                                    <div className="form-group mt-3">
                                        ...
                                        {formik.errors.sroPersonNo && formik.touched.sroPersonNo ? (
                                            <p style={{ color: "red", fontSize: "12px" }}>
...
export default TalukDetailsSurvey