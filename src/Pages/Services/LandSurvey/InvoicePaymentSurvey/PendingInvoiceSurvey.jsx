...
const PendingInvoiceSurvey = () => {
    ...
    const fetchData = useCallback(async () => {
        try {
            const response = await axios.get(
                `${API_BASE_URL}/serviceinvoice?id=${staffid.loginid}&status=pending`,
                {
                    headers: {
                        "Pr-Root": "land",
                        "Level": "service",
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/update_invoice_survey/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
...
export default PendingInvoiceSurvey