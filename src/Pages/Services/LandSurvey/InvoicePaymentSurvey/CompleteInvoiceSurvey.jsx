...
const CompleteInvoiceSurvey = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/update_invoice/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('complete')}`);
    };
...
export default CompleteInvoiceSurvey