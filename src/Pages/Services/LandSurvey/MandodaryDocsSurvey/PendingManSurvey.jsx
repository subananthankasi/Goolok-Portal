...
const PendingManSurvey = () => {
    ...
    //     try {
    //         const response = await axios.get(`${API_BASE_URL}/servicemandatory?id=${staffid.loginid}&status=pending`, {
    //             headers: {
    //                 "Pr-Root": "land",
    //                 "Level": "service",
    //                 "Gl-Status": "Land Survey"
    //             }
    //         });
    //         setLoading(false);
    ...
    const fetchData = useCallback(async () => {
        try {
            const response = await axios.get(
                `${API_BASE_URL}/servicemandatory?id=${staffid.loginid}&status=pending`,
                {
                    headers: {
                        "Pr-Root": "land",
                        "Level": "service",
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/update_mandadory_survey/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
...
export default PendingManSurvey