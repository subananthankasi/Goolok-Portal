...
const CompleteManSurvey = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${API_BASE_URL}/servicemandatory?id=${staffid.loginid}&status=complete`, {
                    headers: {
                        "Pr-Root": "land",
                        "Level": "service",
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/update_mandadory_survey/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('complete')}`);
    };
...
export default CompleteManSurvey