...
const CompleteLocSurvey = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/update_location_survey/${encryptData(rowData.enqry_id)}/${encryptData(rowData.id)}/${encryptData('complete')}`);
    };
...
export default CompleteLocSurvey