...
const fetchData = useCallback(async () => {
    try {
        const response = await axios.get(
            `${API_BASE_URL}/location?id=${staffid.loginid}&status=pending`,
            {
                headers: {
                    "Pr-Root": "land",
                    "Level": "service",
...
useEffect(() => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/update_location_survey/${encryptData(rowData.enqry_id)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
...
export default PendingLocSurvey