...
import AddMoreViewService from "./AddMoreViewService";
import AddMoreDocumentViewService from "./AddMoreDocumentViewService";

const ReminderDocumentVerification = ({ eid, status, pagetype }) => {
                        ...
                        <div className="card shadow border-0">
                            <div className="card shadow border-0 p-4">
                                <div className="d-flex justify-content-between">
                                    <h6>Document Details reminder</h6>
                                </div>
                                <hr />
...
export default ReminderDocumentVerification;
