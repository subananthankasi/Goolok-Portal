...
import AddMoreGetPatta from "./AddMoreGetPatta";
import AnotherAddMoreGetPatta from "./AnotherAddMoreGetPatta";

const WholeDocGetPatta = ({ eid, id, status, pagetype }) => {
  ...
  const serviceCategory = enquiryDoumentData?.service_cat?.toLowerCase();
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      if (serviceCategory === "get patta for your property") {
        navigate("/service_document#Complete");
      } else if (serviceCategory === "find your property google map location") {
        navigate("/documentmap#Complete");
      } else if (serviceCategory === "legal opinion") {
        navigate("/documentlegalopinion#Complete");
      } else if (serviceCategory === "land survey") {
        navigate("/documentlandsurvey#Complete");
      } else if (serviceCategory === "property valuation") {
        navigate("/docvaluation#Complete");
      } else if (serviceCategory === "missing documents") {
        navigate("/doc_verif_missing#Complete");
      }
...
export default WholeDocGetPatta;
