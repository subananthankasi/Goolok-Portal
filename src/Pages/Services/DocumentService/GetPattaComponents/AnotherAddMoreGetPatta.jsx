...
const AnotherAddMoreGetPatta = ({ isOpen, closeModal, data }) => {
  ...
  const fetchInputData = async () => {
    try {
      const response = await axios.get(`${API_BASE_URL}/alldetails/${data.id}`);
...
export default AnotherAddMoreGetPatta;
