...
import AddMoreHub from "./TicketComponent/AddMoreHub";
import AddMoreHubView from "./TicketComponent/AddMoreHubView";
import AddMoreDocumentViewHub from "./TicketComponent/AddMoreDocumentView";
import AddMoreDocumentHub from "./TicketComponent/AddMoreDocumentHub";
import TicketAssigning from "./TicketComponent/TicketAssigning";
...
const UpdateHub = ({ pagetype }) => {
  ...
  const fetchWholedata = async () => {
    try {
      ...
      setEnquiryDocumentData(response.data);
      setLoading(false);
    } catch (error) {
      console.error(error);
    } finally {
      ...
      <section className="section p-1">
        <div className="container-">
          {loadingPage ? (
            ...
            <>
              <div className="row">
                {status === "pending" && pagetype !== "reminder" && (
                ...
                <div className="col-12 mt-4 ">
                  <TicketAssigning eid={eid} id={id} status={status} />
