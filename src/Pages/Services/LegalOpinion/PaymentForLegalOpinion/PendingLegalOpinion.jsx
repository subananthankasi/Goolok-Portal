...
const PendingLegalOpinion = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/update_payment_legal/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
  };
...
export default PendingLegalOpinion
