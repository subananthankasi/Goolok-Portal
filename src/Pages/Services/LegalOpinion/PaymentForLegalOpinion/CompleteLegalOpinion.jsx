...
const CompleteLegalOpinion = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/update_payment_legal/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('complete')}`);
    };
...
export default CompleteLegalOpinion
