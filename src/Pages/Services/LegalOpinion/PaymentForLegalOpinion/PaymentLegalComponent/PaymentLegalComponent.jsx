...
const PaymentLegalComponent = ({ eid, id, status, pagetype }) => {
      ...
      {/* <article className="p-5 mt-5" ref={contentRef} style={{ background: "#fff", display: "none" }} >
                ...
                <div className="d-flex justify-content-between ">
                    <div className="mt-3 mb-5">
                        ...
                        <div className="m-0">
                            <p className='p-0 m-0' ><b>  Goolok Pvt ltd </b></p>
                            <p className='p-0 m-0'> <b>2nd Floor, 129,</b></p>
                            <p className='p-0 m-0' > <b>Nungambakkam, Chennai,</b> </p>
                            <p className='p-0 m-0' > <b>Tamil Nadu 600034 </b></p>
                        </div>
                    </div>

                    <div className="mt-3 mb-5">
                        <p className="p-0 m-0" ><b>Invoice no : </b> {getData[0]?.invoiceid}  </p>
                        <p className="p-0 m-0" ><b> Name: </b> {getData[0]?.customer}  </p>
                        <p className="p-0 m-0" ><b> Date:</b> {getData[0]?.invoice_date} </p>
                        <p className="p-0 m-0" ><b>  Email:</b>{getData[0]?.email_id} </p>
                        <p className="p-0 m-0" ><b>  Mobile:</b>{getData[0]?.mobile} </p>
                ...
                <section className="line-items  ">
                    <table className="items--table w-100 mt-5 p-2 table-bordered">
                        ...
                        <tfoot>
                            <tr>
                                <td colSpan="3" className='text-end p-1' >Sub Total</td>
                                <td colSpan="2" className='text-center' >{calculateTotals().subtotal} </td>
                            </tr>
                            <tr>
                                <td colSpan="3" className='text-end p-1' > GST(0%)</td>
                                <td colSpan="2" className='text-center' >0.00 </td>
                            </tr>
                            <tr>
                                <td colSpan="3" className='text-end p-1' style={{ fontWeight: "600" }}>Total</td>
                    ...
                    <div className="mt-5 mb-5 w-50">
                        ...
                        <p className='p-0 m-0' >payment deadlines, acceptable payment methods, late payment penalties, and other important clauses.</p>
                    </div>
                </section>
...
export default PaymentLegalComponent;
