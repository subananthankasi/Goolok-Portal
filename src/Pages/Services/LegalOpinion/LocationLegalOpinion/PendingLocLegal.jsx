...
const PendingLocLegal = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/update_location_legal/${encryptData(rowData.enqry_id)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
...
export default PendingLocLegal
