...
const CompleteLocLegal = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/update_location_legal/${encryptData(rowData.enqry_id)}/${encryptData(rowData.id)}/${encryptData('complete')}`);
    };
...
export default CompleteLocLegal
