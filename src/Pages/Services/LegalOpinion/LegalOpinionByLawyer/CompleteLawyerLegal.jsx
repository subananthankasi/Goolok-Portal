...
function CompleteLawyerLegal() {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/legal_opinion_lawyer_update/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('complete')}`);
    };
...
export default CompleteLawyerLegal;
