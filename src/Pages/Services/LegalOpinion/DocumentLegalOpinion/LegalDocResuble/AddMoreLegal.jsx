...
const AddMoreLegal = ({ isOpen, closeModal, id }) => {
                        ...
                        /> */}
                                      <DatePicker
                                        ...
                                        onChange={(date) => {
                                          ...
                                          setDeedFormData((prev) => ({
                                            ...prev,
                                            registerDate: formatted,
                                          }));
                                        }}
                                        format="DD/MM/YYYY"
                                        style={{ width: "100%" }}
