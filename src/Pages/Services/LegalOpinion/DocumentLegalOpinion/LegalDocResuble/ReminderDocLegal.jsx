...
import AddMoreLegal from "./AddMoreLegal";
import AddMoreDocDetailsLegal from "./AddMoreDocDetailsLegal";
import customStyle from "../../../../../Utils/tableStyle";
import Toast from "../../../../../Utils/Toast";
import AddMoreViewService from "../../../DocumentService/Reusable/AddMoreViewService";
import AddMoreDocumentViewService from "../../../DocumentService/Reusable/AddMoreDocumentViewService";
// import { fetchEnquiryDocument } from "../../../../Redux/Actions/Enquiry/enquiryReportAction";
// import API_BASE_URL, { IMG_PATH } from "../../../../Api/api";
// import FileView from "../../../../Utils/FileView/FileView";
// import { RedoModel } from "../../../Enquiry/Reusable/RedoStatus";
// import AddMoreService from "./AddMoreService";
// import AddMoreDocumentDetailService from "./AddMoreDocumentDetailService";
// import customStyle from "../../../../Utils/tableStyle";
// import Toast from "../../../../Utils/Toast";


const ReminderDocLegal = ({ eid, id, status,pagetype }) => {
    ...
    const columns = [
        ...
        //           style={{ width: "70px" }}
        //           onClick={() => viewFileUrl(`${IMG_PATH}/enquiry/${row.document}`)}
        //         >
        //           <RemoveRedEyeIcon />
        //         </button>
        //       ) : (
            ...
            cell: (row) => (
                <>
                    <div className="d-flex">
                        ...
                        {staffid.logintype === "staff" && (status === "pending" || status === "complete") && enquiryDoumentData?.status !=="live" && pagetype !=="reminder" && (
                            <button
                                type="button"
...
/> */}
            ...
            <AddMoreViewService
                ...
                id={docId}
            />
            <AddMoreDocumentViewService
                isOpen={isFillView}
                closeModal={() => setIsFillView(false)}
                data={docId}
            />
            <AddMoreDocDetailsLegal
...
export default ReminderDocLegal
