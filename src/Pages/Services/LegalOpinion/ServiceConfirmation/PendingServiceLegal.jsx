...
const PendingServiceLegal = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/update_confirm_legal/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
...
export default PendingServiceLegal
