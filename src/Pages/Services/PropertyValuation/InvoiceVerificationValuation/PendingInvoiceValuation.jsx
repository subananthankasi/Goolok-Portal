...
const PendingInvoiceValuation = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/update_invoice_valuation/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
  };
...
export default PendingInvoiceValuation