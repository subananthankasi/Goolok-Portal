...
const AddMoreViewValuation = ({ isOpen, closeModal, id }) => {
                                                    ...
                                                    <TableContainer component={Paper}>
                                                        <Table sx={{ minWidth: 700 }} aria-label="customized table" >
                                                            ...
                                                            <TableFooter>
                                                                ...
                                                                {/* <TableCell align="right" colSpan={'5'} style={{ fontSize: '14px' }}> </TableCell > */}
                                                                {/* )} */}
                                                                <TableCell colSpan={'4'} className="text-center" style={{ fontSize: '14px' }}>
...
export default AddMoreViewValuation