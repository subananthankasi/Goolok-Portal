...
import AddMoreDocDetailViewValution from "./AddMoreDocDetailViewValution";
import AddMoreViewValuation from "./AddMoreViewValuation";
import AddMoreValution from "./AddMoreValution";
import AddMoreDocDetailValution from "./AddMoreDocDetailValution";
import customStyle from "../../../../../Utils/tableStyle";
import Toast from "../../../../../Utils/Toast";

const ReminderDocVerifyValution = ({ eid, status, pagetype }) => {
        ...
        <>
          <button
            ...
            className={`badge rounded-pill btnhover btn p-2 ${
              row.status == "verify" ? "bg-success" : "bg-danger"
            }`}
            style={{ width: "60px" }}
          >
            {row.status == "verify"
  ...
  return (
    <>
      ...
      {/* <AddMoreView
        ...
        id={docId}
      /> */}
      <AddMoreDocDetailViewValution
        isOpen={isFillView}
        closeModal={() => setIsFillView(false)}
        data={docId}
      />
      <AddMoreViewValuation
...
export default ReminderDocVerifyValution;
