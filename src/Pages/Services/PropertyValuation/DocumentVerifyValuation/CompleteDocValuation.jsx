...
const CompleteDocValuation = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        // navigate(`/document_set_valuation/${rowData.id}/${rowData.userid}/complete`);
...
export default CompleteDocValuation