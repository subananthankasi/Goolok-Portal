...
const WaitinghubValuation = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/servicehub/new`, {
                headers: {
                    "Pr-Root": "land",
                    "Level": "service",
    ...
    const handleConfirm = async () => {
        ...
        try {
            await axios.put(`${API_BASE_URL}/servicehub/${docId}`, updateData, {
                headers: {
...
export default WaitinghubValuation