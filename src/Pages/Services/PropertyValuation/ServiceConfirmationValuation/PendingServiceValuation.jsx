...
const PendingServiceValuation = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/update_confirm_valuation/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
...
export default PendingServiceValuation