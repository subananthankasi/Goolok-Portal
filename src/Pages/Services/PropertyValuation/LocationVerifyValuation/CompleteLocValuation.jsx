...
const CompleteLocValuation = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/update_location_valuation/${encryptData(rowData.enqry_id)}/${encryptData(rowData.id)}/${encryptData('complete')}`);
    };
...
export default CompleteLocValuation