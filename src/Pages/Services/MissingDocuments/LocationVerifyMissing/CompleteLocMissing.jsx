...
const CompleteLocMissing = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/update_location_missing/${encryptData(rowData.enqry_id)}/${encryptData(rowData.id)}/${encryptData('complete')}`);
    };
...
export default CompleteLocMissing