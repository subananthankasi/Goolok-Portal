...
const LocationSelectMissingDocument = ({ eid, id, status, pagetype }) => {
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            navigate("/location_missing#Complete");
        } catch (error) {
            const errorMessage =
                                ...
                                {surveyData.length !== 0 ? (
                                    ...
                                    <tr>
                                        <td colSpan="4" className="p-4 text-center">
                                            {" "}
                                            Please Add Survey Number in Document Verification Page ...
                                        </td>
                                    </tr>
                                )}
                                {/* {
...
export default LocationSelectMissingDocument;
