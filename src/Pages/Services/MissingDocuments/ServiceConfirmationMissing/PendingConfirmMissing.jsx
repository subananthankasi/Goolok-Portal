...
const PendingConfirmMissing = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/update_service_confirm_missing/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
...
export default PendingConfirmMissing