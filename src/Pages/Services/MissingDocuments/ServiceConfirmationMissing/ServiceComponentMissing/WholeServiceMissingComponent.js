...
import ConfirmServiceMissing from './ConfirmServiceMissing';
import AddServiceMissing from './AddServiceMissing';
...
const WholeServiceMissingComponent = ({ eid, id, status, pagetype }) => {
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            navigate("/service_confirm_missing#Complete")
        } catch (error) {
    ...
    return (
        <div className="col-12 mt-4">
            ...
            <AlertPop
                ...
                message={errorMsg}
            />
            <ConfirmServiceMissing eid={eid} id={id} status={status} pagetype={pagetype} />
            <AddServiceMissing eid={eid} id={id} status={status} pagetype={pagetype} />
...
export default WholeServiceMissingComponent