...
import AddMoreMissing from "./AddMoreMissing";
import AnotherAddMoreMissing from "./AnotherAddMoreMissing";

const WholeComponentDocVerifyMissing = ({ eid, id, status, pagetype }) => {
  ...
  const columns = [
...

    {
      ...
      cell: (row) => {
        ...
        return (
          <>
            {staffid.logintype === "staff" && pagetype !== "reminder" && enquiryDoumentData?.status !== "live" ? (
              <button
                type="button"
        ...
        <div className="card shadow border-0">
          <div className="card shadow border-0 p-4">
            <div className="d-flex justify-content-between">
              ...
              {staffid.Login === "staff" && pagetype !== "reminder" && enquiryDoumentData?.status !== "live" && (
                <div className="ms-2">
                  <a
                    href="#"
                  ...
                  <div className="row">
                    ...
                    <div className="col-6">
                      ...
                      <div className=" row mt-5">
                        ...
                        <div className="col-6">{titlTwoview?.sro}</div>
                      </div>
                    </div>
                  </div>
                )}
...
export default WholeComponentDocVerifyMissing;
