...
const PendingInvoiceMissing = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/update_invoice_missing/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
  };
...
export default PendingInvoiceMissing