...
import WaitingLocationService from "./WaitingLocationService";
import PendingLocationService from "./PendingLocationService";
import CompleteLocationService from "./CompleteLocationService";
            ...
            <div className="col-12">
              <div className="card">
                ...
                <div className="card-b ody">
                  {step === 1 && (
                    <>
                      <WaitingLocationService />
                    </>
                  )}

                  {step === 2 && (
                    <>
                      <PendingLocationService />
                    </>
                  )}
                  {step === 3 && (
                    <>
