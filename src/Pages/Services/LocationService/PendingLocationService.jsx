...
const PendingLocationService = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/update_location/${encryptData(rowData.enqry_id)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
...
export default PendingLocationService