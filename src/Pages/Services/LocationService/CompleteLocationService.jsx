...
const CompleteLocationService = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/update_location/${encryptData(rowData.enqry_id)}/${encryptData(rowData.id)}/${encryptData('complete')}`);
  };
...
export default CompleteLocationService