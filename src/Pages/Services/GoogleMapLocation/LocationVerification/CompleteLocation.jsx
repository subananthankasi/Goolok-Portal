...
const CompleteLocation = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await axios.get(
                `${API_BASE_URL}/location?id=${staffid.loginid}&status=complete`,
                {
                    headers: {
                        "Pr-Root": "all",
                        "Level": "service",
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/update_location_map/${encryptData(rowData.enqry_id)}/${encryptData(rowData.id)}/${encryptData('complete')}`);
    };
