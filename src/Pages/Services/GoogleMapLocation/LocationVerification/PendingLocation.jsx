...
const PendingLocation = () => {
    ...
    //                 "Pr-Root": "land",
    //                 "Level": "service",
    //                 "Gl-Status": "find your property google map location"
    //             }
    //         });
    //         setLoading(false);
...
useEffect(() => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/update_location_map/${encryptData(rowData.enqry_id)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
    };
