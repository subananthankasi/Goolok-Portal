...
import AddMoreGoogle from "./AddMoreGoogle";
import AddMoreDocDetailsGoogle from "./AddMoreDocDetailsGoogle";
...
const ReminderDocVerificationGoogle = ({ eid, status, pagetype }) => {
...
export default ReminderDocVerificationGoogle;
