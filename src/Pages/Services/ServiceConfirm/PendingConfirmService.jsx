...
const PendingConfirmService = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/update_confirm/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
...
export default PendingConfirmService