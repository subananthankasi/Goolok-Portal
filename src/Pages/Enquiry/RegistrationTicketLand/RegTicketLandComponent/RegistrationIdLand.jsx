...
const RegistrationIdLand = ({ eid, id, status, shortform, bookingid, pagetype }) => {
    ...
    const subproperty = useSelector((state) => state.SubPropertyType.SubPropertyTypeData);
    ...
    const handleDelete = async (row) => {
        try {
            const response = await axios.delete(`${API_BASE_URL}/confirmation/${deleteId}`)
    ...
    const onSubmit = async (values) => {
        ...
        try {
            const response = await axios.post(`${API_BASE_URL}/ticketbooking`, payload)
            fetch()
            if (editing) {
    ...
    const fetch = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/ticketbooking/${bookingid}/edit`)
        ...
        <>
                    ...
                    <div className="card shadow border-0 p-4">
                            ...
                            {Object.keys(registerData).length > 0 && (
                                staffid.logintype == "staff" && (status === "complete" || status === "pending") && pagetype !== "reminder" && (
                                    <div className="d-flex gap-2">
                                        <button className="editButton" onClick={handleEdit}> <EditIcon /></button>
                                    </div>
                                )
                            )}
                        </div>
                        ...
                        {Object.keys(registerData).length === 0 ? (
                            ...
                            <table className="table table-bordered" style={tableStyle}>
                                <tbody>
                                    <tr>
                                        <td style={{ ...cellStyle, ...highlightStyle }} >Registration ID</td>
                                        <td style={cellStyle}>{registerData?.reg_id} </td>
                                    </tr>
                                    <tr>
                                        <td style={{ ...cellStyle, ...highlightStyle }} >Category  </td>
                                        <td style={cellStyle}>{registerData?.categoryname} </td>
                                    </tr>
                                    <tr>
                                        <td style={{ ...cellStyle, ...highlightStyle }} >Sub Category</td>
                                    ...
                                    <tr>
                                        <td style={{ ...cellStyle, ...highlightStyle }} >District </td>
                                    ...
                                    <tr>
                                        <td style={{ ...cellStyle, ...highlightStyle }} >Village </td>
                                    ...
                                    <tr>
                                        <td style={{ ...cellStyle, ...highlightStyle }}>Property Type </td>
                                        <td style={cellStyle}> {registerData?.property_type}</td>
                                    </tr>
                                    <tr>
                                        <td style={{ ...cellStyle, ...highlightStyle }}>Extent In Unit </td>
            ...
            >
                <form onSubmit={formik.handleSubmit} autoComplete="off">
                        ...
                        <div className="col-6">
                            ...
                            <div className="form-group mt-1">
                                ...
                                >
                                    ...
                                    {subproperty ? subproperty?.filter((item) => item.property === formik.values.category).map((item) => (
                                        <option key={item.id} value={item.id}>
                                            {item.subproperty}
                                        </option>
                            ...
                            <div className="form-group mt-2">
                                <label className="form-label"> Extent in Units :<span style={{ color: "red" }}>*</span></label>
                                <input
                                    type="text"
                                    className="form-control"
                                    name="extent_unit"
                            ...
                            <div className="form-group mt-2">
                                ...
                                >
                                    ...
                                    {SRODetailsData && SRODetailsData?.map((item) => (
                                        <option key={item.id} value={item.id}>
                                            {item.sro_title}
                                        </option>
                                    ))}
                        ...
                        <div className="col-6">
                            <div className="form-group mt-1">
                                ...
                                >
                                    ...
                                    {StateNameData && StateNameData.map((item) => (
                                        <option key={item.id} value={item.id}>
                                            {item.state_name}
                                        </option>
                                    ))}
                            ...
                            <div className="form-group mt-1">
                                ...
                                >
                                    ...
                                    {districtData ? districtData?.filter((item) => item.state_type === formik.values.state).map((item) => (
                                        <option key={item.id} value={item.id}>
                                            {item.district}
                                        </option>
                            ...
                            <div className="form-group mt-1">
                                ...
                                >
                                    ...
                                    {TalukData ? TalukData?.filter((item) => item.taluk_district === formik.values.district).map((item) => (
                                        <option key={item.id} value={item.id}>
                                            {item.taluk_name}
                                        </option>
                            ...
                            <div className="form-group mt-1">
                                ...
                                >
                                    ...
                                    {VillageData ? VillageData?.filter((item) => item.village_taluk === formik.values.taluk).map((item) => (
                                        <option key={item.id} value={item.id}>
                                            {item.village_name}
                                        </option>
                                    )) : <option value="">No Taluk Available</option>}
                    ...
                    <div className="d-flex justify-content-end mt-4">
                        <Button variant="contained" type="submit" onClick={() => setEditing(false)}>
                            Submit
                        </Button>
                    </div>
                </form>
            ...
            >
                <form onSubmit={formik.handleSubmit} autoComplete="off">
                    ...
                    <div className="d-flex justify-content-end mt-4">
                        <Button variant="contained" type="submit" onClick={() => setEditing(true)}>
                            Update
                        </Button>
                    </div>
                </form>
...
export default RegistrationIdLand