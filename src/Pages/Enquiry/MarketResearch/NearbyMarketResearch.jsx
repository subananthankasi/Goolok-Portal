...
const NearbyMarketResearch = ({ eid, status, marketid, pagetype }) => {
 ...
 const enquiryDoumentData = useSelector(
    ...
    const formik = useFormik({
        ...
        //     facing_width: yup.string().required('facing_width is required !!'),
                            ...
                            <div className="row">
                                ...
                                <div className="col-7 mb-3">
                                    <input
                                        ...
                                        maxLength="1000"
                                    />
                                    {formik.errors.water_level && formik.touched.water_level ? (
                                        <p style={{ color: "red", fontSize: "12px" }}>
                                            {formik.errors.water_level}
                                        </p>
                                    ) : null}
                                </div>
                            </div>
...
export default NearbyMarketResearch;
