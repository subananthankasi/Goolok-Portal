...
const CustomerMarketResearch = ({ eid, marketid, status, pagetype }) => {
  ...
  const customerColumns = [
    ...
    {
      name: "Price per Unit",
      // selector: (row) => `${row.unit} ${enquiryDoumentData?.land_units}`,
      selector: (row) =>
    ...
    {
      name: "Land Fertility",
      selector: (row) => row.fertility,
      sortable: true,
      width: "150px",
    },
    {
      name: "Soil Type",
      selector: (row) => row.soil_type,
      sortable: true,
      width: "150px",
    },
    {
      name: "Vegetation",
      selector: (row) => row.vegetation,
      sortable: true,
      width: "150px",
    },
    {
  ...
  const formik = useFormik({
    ...
    //     .matches(/^[0-9.,]+$/, "Only numbers, commas and dots are allowed !!"),
    //   facing_width: yup
    //     .string()
    ...
    //   land_fertility: yup
    //     .string()
    //     .required("land_fertility is required !!")
    //     .matches(
    //       /^[A-Za-z\s]+$/,
    //       "land_fertility must contain only letters and spaces"
    //     ),
    //   soil_type: yup
    //     .string()
    //     .required("soil_type is required !!")
    //     .matches(
    //       /^[A-Za-z\s]+$/,
    //       "soil_type must contain only letters and spaces"
    //     ),
    //   vegetation: yup
    //     .string()
    //     .required("vegetation is required !!")
    //     .matches(
    //       /^[A-Za-z\s]+$/,
    //       "vegetation must contain only letters and spaces"
    //     ),
    //   direction: yup
    //     .string()
        ...
        <form onSubmit={formik.handleSubmit} autoComplete="off">
          <div className="row">
            ...
            <div className="col-md-12 col-lg-6 mb-3">
              <div className="row">
                <div className="col-4 mb-3">
                  <label htmlFor="land_classification" className="form-label">
                    Land Classification
                  </label>
                </div>
                <div className="col-7 mb-3">
            ...
            <div className="col-md-12 col-lg-6 mb-3">
              <div className="row">
                <div className="col-4 mb-3">
                  <label htmlFor="land_fertility" className="form-label">
                    Land Fertility
                  </label>
                </div>
                <div className="col-7 mb-3">
                  <input
                    ...
                    id="land_fertility"
                    name="land_fertility"
                    value={formik.values.land_fertility}
                    onChange={formik.handleChange}
                    onBlur={formik.handleBlur}
                  />
                  {formik.errors.land_fertility &&
                    formik.touched.land_fertility ? (
                    <p style={{ color: "red", fontSize: "12px" }}>
                      {formik.errors.land_fertility}
                    </p>
                  ) : null}
              ...
              <div className="row">
                ...
                <div className="col-7 mb-3">
                  <input
                    ...
                    id="soil_type"
                    name="soil_type"
                    value={formik.values.soil_type}
                    onChange={formik.handleChange}
                    onBlur={formik.handleBlur}
                  />
                  {formik.errors.soil_type && formik.touched.soil_type ? (
                    <p style={{ color: "red", fontSize: "12px" }}>
            ...
            <div className="col-md-12 col-lg-6 mb-3">
              <div className="row">
                <div className="col-4 mb-3">
                  <label htmlFor="vegetation" className="form-label">
                    Vegetation
                  </label>
                </div>
                <div className="col-7 mb-3">
                  <input
                    ...
                    onBlur={formik.handleBlur}
                  />
                  {formik.errors.vegetation && formik.touched.vegetation ? (
                    <p style={{ color: "red", fontSize: "12px" }}>
                      {formik.errors.vegetation}
                    </p>
                  ) : null}
                </div>
              </div>
...
export default CustomerMarketResearch;
