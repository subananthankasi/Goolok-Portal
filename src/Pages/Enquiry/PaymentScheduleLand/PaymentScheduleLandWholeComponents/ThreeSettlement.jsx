  ...
  return (
    <>
      <div className="container">
        {!visible &&
        readyCashData[0]?.pay_option === "3 Settlements" &&
        readyCashData.length > 0 ? (
          ...
          //             <div className="row mt-3">
          //                 <div className="col-4">
          //                     <label className='form-label'>Total Amount Payable (After discount)</label>
          //                 </div>
          //                 <div className="col-8">
          //                     <input
          //                         type='text'
          ...
          <div className="d-flex justify-content-center">
            <button onClick={() => setNewDialog1(true)} className="btn1">
              Create 3 Settlement
            </button>
          </div>
        )}
      ...
      >
       ...
       <Dialog
        ...
        style={{ width: "62rem" }}
        breakpoints={{ "960px": "75vw", "641px": "90vw" }}
        header="Update 3 Settlement"
        modal
        onHide={() => setEditDialog1(false)}
      >
        <form onSubmit={formik.handleSubmit}>
          <div className="row">
            <div className="col-6">
...
export default ThreeSettlement;
