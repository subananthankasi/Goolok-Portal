...
const CompletePayment = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/payment_schedule/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("complete")}/${encryptData(rowData.booking_id)}/${encryptData(rowData.booking_no)}`);
    };
