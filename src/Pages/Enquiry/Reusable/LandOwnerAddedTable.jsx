...
const LandOwnerAddedTable = ({ eid, id, status, pagetype }) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object().shape({
      ...
      direction: yup.string().required("Facing direction is required!"),
      ...
      dimension: yup
        ...
        .required("At least one dimension is required")
        .min(1),
      ...
      boundry: yup
        ...
        .required("At least one boundary is required")
        .min(1),
    }),
    onSubmit,
  });
  ...
  const handleEdit = (item) => {
    ...
    formik.setFieldValue("extent", landDetails.extent || "");
    formik.setFieldValue("remark", landDetails.remark || "");
    formik.setFieldValue("direction", landDetails.direction || "");
    formik.setFieldValue("propertytype", landDetails.propertytype || "");
              ...
              >
                <thead>
                  <tr className="text-center">
                    ...
                    <th
                      className="landowner_enq_th"
                      style={{ minWidth: "150px" }}
                    >
                      {getData[0]?.patta_type === "Town_patta" &&
                      getData[0]?.subpro_name !== "Agricultural Land"
                        ? "Town Survey No"
                        : "Survey No"}{" "}
                    </th>
                    ...
                    getData[0]?.subpro_name !== "Agricultural Land" ? (
                      <>
                        <th className="landowner_enq_th_1">Old Survey No</th>
                        <th className="landowner_enq_th_1">Old Sub-Division</th>
                      </>
                    ) : null}

                    <th className="landowner_enq_th_1">Extent in Sq.Ft.</th>
                    <th className="landowner_enq_th_1">Facing Direction</th>
                    <th className="landowner_enq_th_1">Property Type</th>
                    ...
                    <th className="landowner_enq_th">Remark</th>
                    {staffid.Login === "staff" &&
                  ...
                  <tr className="text-center">
                    {getData[0]?.patta_type === "Town_patta" &&
                    getData[0]?.subpro_name !== "Agricultural Land" ? (
                      <th colSpan="8" className="landowner_enq_th"></th>
                    ) : (
                  ...
                  {getData?.map((item, index) => {
                    ...
                    return (
                      <tr key={index} className="text-center">
                        ...
                        <td>{landDetails.extent} </td>
                        <td>{landDetails.direction} </td>
                        <td>{landDetails.propertytype} </td>
                        ...
                        {landDetails.boundry &&
                        Array.isArray(landDetails.boundry) ? (
        ...
        <form onSubmit={formik.handleSubmit} autoComplete="off">
            ...
            <>
              <div className="row">
                <div className="form-group mt-2 col-6">
                  ...
                  {formik.errors.old_survey_no &&
                  formik.touched.old_survey_no ? (
                    <p style={{ color: "red", fontSize: "12px" }}>
                      {formik.errors.old_survey_no}
                    </p>
                  ) : null}
          ...
          <div className="row">
            <div className="form-group mt-2 col-6">
              ...
              formik.touched.boundry?.[0]?.north ? (
                <p style={{ color: "red", fontSize: "12px" }}>
                  {formik.errors.boundry[0].north}
                </p>
              ) : null}
            ...
            <div className="form-group mt-2 col-6">
              ...
              formik.touched.boundry?.[0]?.south ? (
                <p style={{ color: "red", fontSize: "12px" }}>
                  {formik.errors.boundry[0].south}
                </p>
              ) : null}
          ...
          <div className="row">
            <div className="form-group mt-2 col-6">
              ...
              formik.touched.boundry?.[0]?.others ? (
                <p style={{ color: "red", fontSize: "12px" }}>
                  {formik.errors.boundry[0].others}
                </p>
              ) : null}
...
export default LandOwnerAddedTable;
