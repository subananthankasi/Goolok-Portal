...
export const ApartFinalOpinion = (props) => {
    ...
    const fetchFinalOpinion = async () => {
      try {
        const response = await axios.get(`${API_BASE_URL}/allopinions/${props.data.eid}`, {
          headers: {
            'Gl-status': "All"
          }
        })
  ...
  const FinalOpinionModal = ({ isOpen, closeModal, enqid, fetchFinalOpinion }) => {
    ...
    const handleSubmit = async () => {
      ...
      if (isValid) {
        ...
        try {
          ...
          const response = await axios.post(`${API_BASE_URL}/addopinion`, formDataToSubmit, {
            headers: {
                      ...
                      <div className="col-md-12 mb-3">
                        <div className="row align-items-center">
                          ...
                          <div className="col-8">
                            ...
                            />
                            {errors.file && <span className="validation_msg">{errors.file}</span>}
                          </div>
                        </div>
                      </div>
  ...
  const FinalOpinionModalEdit = ({ isOpen, closeModal, editData, fetchFinalOpinion }) => {
                            ...
                            <div className="row">
                              ...
                              <div className="col-2 text-end">
                                <button
                                  type="button"
                                  className="btn btn-warning rounded-0"
                                  onClick={() => FileDownload(`${IMG_PATH}/enquiry/lawyer/${formData.oldfile}`)}
                                >
                                  <RemoveRedEyeIcon />
                                </button>
                              </div>
                            </div>
                            {errors.document && <span className="validation_msg">{errors.document}</span>}
                          </div>
                        </div>
                      </div>
