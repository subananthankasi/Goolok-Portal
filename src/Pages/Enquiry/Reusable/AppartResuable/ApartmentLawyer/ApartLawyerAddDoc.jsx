...
import { AddMoreLawyerDocumentDetails } from "../../Lawyer/AddMoreLawyerDocumentDetails";
...
export const ApartLawyerAddDoc = (props) => {
    ...
    const columns = [
            ...
            <div className="d-flex p-0">
              {row.upload_type == "lawyer" ? (
                <>
                  ...
                  {((props.data.status == "pending" || props.data.status === "complete")&&  props.data.pagetype !== "reminder" && staffid.Login == "staff") &&
        ...
        cell: (row) => (
          <>
            {row.upload_type == "lawyer" ? (
              ...
              >
                {((props.data.status === "pending" || props.data.status === "complete") && staffid.Login == "staff") ? 'Fill Details..' : 'View'}
              </button>
            ) : (
              <button
                type="button"
        ...
        cell: (row) => (
          <>
            <button
              ...
              style={{ width: "60px" }}
              onClick={() => {
                if (row.upload_type == "lawyer" && props.data.status == "pending" && staffid.Login == "staff") {
      ...
      ...(staffid.Login == "staff" && (props.data.status == "pending" && props.data.status == "complete")
        ? [
          {
            name: "Actions",
            cell: (row) =>
              ...
              <div className="border-0">
                <div className="border-0">
                  <div className="d-flex justify-content-between mb-3">
                    ...
                    {(props.data.status === "pending" || props.data.status === "complete") && staffid.Login === "staff" && props.data.pagetype !== "reminder" && (
                      <div className="ms-2">
                        <a
                          href="#"
