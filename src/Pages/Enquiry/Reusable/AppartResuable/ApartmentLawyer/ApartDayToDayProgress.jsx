...
export const ApartDayToDayProgress = (props) => {
    ...
    const fetchDayToDayProgress = async () => {
      try {
        const response = await axios.get(`${API_BASE_URL}/allprogress/${props.data.eid}/lawyer`)
  ...
  export default ApartDayToDayProgress;
  
  const AddDayProcess = ({ isOpen, closeModal, enqid, fetchDayToDayProgress }) => {
    ...
    const handleSubmit = async () => {
      ...
      if (isValid) {
        setloading(true);
        try {
          const response = await axios.post(`${API_BASE_URL}/addprogress`, formData, {
            headers: {
              ...
              <div className="card-body p-3">
                <form>
                  <div className="mt-3 mb-4 row">
                    <div className="col-12 mt-3">
                      <div className="row">
                        ...
                        <div className="col-8">
                          <input className="form-control" type="date" name="open_date" value={formData.open_date} onChange={handleChange} />
                          {errors.open_date && (<div className="validation_msg"> {errors.open_date}</div>)}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="col-12 mt-3">
                      <div className="row">
                        ...
                        <div className="col-8">
                          <input className="form-control" type="text" name="remark" value={formData.remark} onChange={handleChange} />
                          {errors.remark && (<div className="validation_msg"> {errors.remark}</div>)}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="col-12 mt-3">
                      <div className="row">
                        ...
                        <div className="col-8">
                          <input className="form-control" type="date" name="next_date" value={formData.next_date} onChange={handleChange} />
                          {errors.next_date && (<div className="validation_msg"> {errors.next_date}</div>)}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="text-end mt-4">
                    ...
                    <button className="btn1" type="button" onClick={handleSubmit} disabled={loading}>
                      {loading ? (
                        <>
  ...
  const UpdateDayProcess = ({ isOpen, closeModal, fetchDayToDayProgress, editData }) => {
