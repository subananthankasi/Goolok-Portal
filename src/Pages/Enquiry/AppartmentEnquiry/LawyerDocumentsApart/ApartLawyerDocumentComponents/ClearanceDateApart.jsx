...
export const ClearanceDateApart = (props) => {
    ...
    const editSettings = {
        allowEditing: (props.data.status === "pending" || props.data.status === "complete") && staffid.Login === "staff" && props.data.pagetype !== "reminder" && enquiryDoumentData?.status !== "booking" ? true : false,
        mode: "Dialog",
    ...
    function dialogTemplate(props) {
        return <DialogFormTemplate props={props} setSelectedFile={setSelectedFile} />;
    }
    ...
    async function actionComplete(args) {
        ...
        if (args.action === "edit") {
            ...
            formData.append("tax_receipt", args.data.tax_receipt);
            formData.append("certificate_no", args.data.certificate_no);
            formData.append("noc", args.data.noc);
                        ...
                        <div className="card shadow border-0 p-4">
                            <div className='d-flex justify-content-between gap-4' >
                                ...
                                <Calendar
                                    ...
                                    className='mb-2'
                                    style={{ height: '30px' }}
                                    disabled={props.data.pagetype === "reminder" || staffid.Login === "admin" || enquiryDoumentData?.status === "booking" ? true : false}
                                />
                            </div>
                                ...
                                <div className="control-section">
                                    ...
                                    >
                                        <ColumnsDirective>
                                            ...
                                            <ColumnDirective field="survey_no" headerText={`${surveyData?.[0]?.patta_type === "Town_patta" ? "Town Survey No" : "Survey No"}`} width="150" />
                                            <ColumnDirective field="sub_division" headerText="Sub division" width="150" />
                                            {surveyData?.[0]?.patta_type === "Town_patta" && (
                                                <ColumnDirective field="old_survey_no" headerText="Old Survey no" width="150" />
                                            )}
                                            {surveyData?.[0]?.patta_type === "Town_patta" && (
                                                <ColumnDirective field="old_sub_division" headerText="Old Sub Division" width="150" />
                                            )}
                                            <ColumnDirective field="power_agent" headerText="Power agent" width="150" validationRules={{ required: true }} />
                                            <ColumnDirective
                                            ...
                                            />
                                            <ColumnDirective field="last_saledeed_no" headerText="Last sale deed No" width="150" />
                                            <ColumnDirective field="partners" headerText="Partners" width="150" />
                                            <ColumnDirective field="etc" headerText="etc" width="150" />
                                            <ColumnDirective field="certificate_no" headerText="Completion Certificate No." width="150" />
                                            <ColumnDirective field="tax_receipt" headerText="Land Tax Receipt" width="150" />
                                            ...
                                            <ColumnDirective
                                                ...
                                                template={(props) => {
                                                    return (
                                                        props.wanted ? (
                                                            <button className='btn' onClick={() => window.open(`${IMG_PATH}/enquiry/${props.wanted}`, "_blank")}><PictureAsPdfIcon sx={{ color: "red" }} /> </button>
                                                        ) : null)
                                                }}
                                            />
    ...
    return (
        <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="form-group col-6 col-md-6 mb-3">
                        <div className="e-float-input e-control-wrapper">
                            ...
                            />
                            <span className="e-float-line"></span>
                            <label className="e-float-text e-label-top">Old Sub division</label>
                        </div>
                    </div>
                </div>
            )}
            ...
            <div className="row">
                <div className="form-group col-6 col-md-6 mb-3">
                    <div className="e-float-input e-control-wrapper">
                        ...
                        />
                        <span className="e-float-line"></span>
                        <label className="e-float-text e-label-top"> Completion Certificate No.</label>
                    </div>
                </div>
                ...
                <div className="form-group col-6 col-md-6 mb-3">
                    <div className="e-float-input e-control-wrapper">
                        <input
                            ...
                            name="tax_receipt"
                            type="text"
                            value={formData.tax_receipt || ''}
                            onChange={onChange}
                        />
                        <span className="e-float-line"></span>
                        <label className="e-float-text e-label-top">Land Tax Receipt</label>
                    </div>
                </div>
            </div>
            ...
            <div className="row">
                ...
                {
                    props.wanted ? (
                        <div className='col-md-1 mb-3 text-center d-flex' style={{ textAlign: "center", alignItems: "center" }}>
                            <button className='btn' onClick={() => window.open(`${IMG_PATH}/enquiry/${props.wanted}`, "_blank")}><VisibilityIcon sx={{ fontSize: 25 }} /></button>
                        </div>
