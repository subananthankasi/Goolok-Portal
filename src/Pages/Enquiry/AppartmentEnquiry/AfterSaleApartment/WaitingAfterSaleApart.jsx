...
const WaitingAfterSaleApart = () => {
    const [WaitingData, setWaitingData] = useState([]);

    const fetchData = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/aftersaledpt/new`, {
                headers: {
                    "Pr-Root": "apartment",
                },
            });
    ...
    const handleConfirm = async () => {
        ...
        try {
            await axios.put(`${API_BASE_URL}/aftersaledpt/${docId}`, payload, {
                headers: {
...
export default WaitingAfterSaleApart;
