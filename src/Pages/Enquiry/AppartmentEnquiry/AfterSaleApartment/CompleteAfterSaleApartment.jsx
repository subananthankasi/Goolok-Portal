...
const CompleteAfterSaleApartment = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/after_sale_land/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("complete")}/${encryptData(rowData.bid)}/${encryptData(rowData.booking_no)}`);
    };
...
export default CompleteAfterSaleApartment;
