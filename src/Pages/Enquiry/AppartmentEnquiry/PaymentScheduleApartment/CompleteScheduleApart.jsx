...
const CompleteScheduleApart = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/paymentschedule_apartment/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("complete")}/${encryptData(rowData.booking_id)}/${encryptData(rowData.booking_no)}`);
    };
...
export default CompleteScheduleApart;
