...
const PendingScheduleApart = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/payment_schedule/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("pending")}/${encryptData(rowData.booking_id)}/${encryptData(rowData.booking_no)}`);
    };
...
export default PendingScheduleApart