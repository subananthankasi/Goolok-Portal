...
// import { pricingWaitingTakeThunk, pricingWaitingThunk } from '../../../Redux/Actions/Enquiry/PricingEnquiryThunk';
...
const WaitingPricingDptApart = () => {
  ...
  useEffect(() => {
    ...
    const handleConfirm = async () => {
        ...
        try {
            await axios.put(`${API_BASE_URL}/pricingdpt/${docId}`, updateData, {
                headers: {
...
export default WaitingPricingDptApart