...
import { AddDocumentDropdown, AddDocumentPendingCreate, AddDocumentPendingget } from "../../../../Redux/Actions/ApartmentDocument/AddDocument";
...
const UpdateStageDocumentVerifyApart = ({ eid, id, status }) => {
    ...
    const handleClose = () => {
        // dispatch( AddDocumentPendingCreate({id,Document}))
        setOpensadd(false);
    };
