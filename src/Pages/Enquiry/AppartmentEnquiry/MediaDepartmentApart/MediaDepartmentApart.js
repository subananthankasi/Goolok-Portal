...
import WaitingMediaApart from "./WaitingMediaApart";
import PendingMediaApart from "./PendingMediaApart";
import CompleteMediaApart from "./CompleteMediaApart";

const MediaDepartmentApart = () => {
...
export default MediaDepartmentApart