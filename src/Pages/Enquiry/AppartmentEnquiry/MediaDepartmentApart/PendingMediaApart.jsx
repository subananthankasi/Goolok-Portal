...
// import { mediaPendingThunk } from '../../../Redux/Actions/Enquiry/MediaDptEnq/MediaDptEnqThunk';
...
const PendingMediaApart = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/apart_media_department/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("pending")}`);
    };
...
export default PendingMediaApart