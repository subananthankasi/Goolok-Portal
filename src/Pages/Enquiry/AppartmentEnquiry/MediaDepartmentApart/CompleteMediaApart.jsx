...
// import { mediaCompleteThunk } from "../../../Redux/Actions/Enquiry/MediaDptEnq/MediaDptEnqThunk";
...
const CompleteMediaApart = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/apart_media_department/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("complete")}`);
      };
    return (
        <>
...
export default CompleteMediaApart