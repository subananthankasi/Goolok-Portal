...
const WaitingRegTicketApart = () => {
    const [WaitingData, setWaitingData] = useState([]);

    const fetchData = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/ticketbooking/new`, {
                headers: {
                    "Pr-Root": "apartment",
                },
            });
    ...
    const handleConfirm = async () => {
        ...
        try {
            await axios.put(`${API_BASE_URL}/ticketbooking/${docId}`, payload, {
                headers: {
...
export default WaitingRegTicketApart;
