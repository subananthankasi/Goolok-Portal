...
function WaitingRegisterLand() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/registration/new`, {
                headers: {
                    "Pr-Root": "land"
                }
            })
    ...
    const handleConfirm = async () => {
        ...
        try {
            await axios.put(`${API_BASE_URL}/registration/${docId}`, updateData, {
                headers: {
...
export default WaitingRegisterLand;
