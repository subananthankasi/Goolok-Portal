...
import WaitingRegisterLand from "./WaitingRegisterLand";
import PendingRegisterLand from "./PendingRegisterLand";
import CompleteRegisterLand from "./CompleteRegisterLand";


const RegistrationLand = () => {
...
export default RegistrationLand;
