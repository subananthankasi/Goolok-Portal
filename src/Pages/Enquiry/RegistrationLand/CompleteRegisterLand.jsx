...
const CompleteRegisterLand = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(
                `${API_BASE_URL}/registration?id=${staffid.loginid}&status=complete`,
                {
                    headers: {
                        "Pr-Root": "land",
                    },
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/registeration/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("complete")}/${encryptData(rowData.bid)}/${encryptData(rowData.booking_no)}/${encryptData("complete")}`);
    };
...
export default CompleteRegisterLand;
