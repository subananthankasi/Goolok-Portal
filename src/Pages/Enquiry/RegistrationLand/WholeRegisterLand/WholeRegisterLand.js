...
const WholeRegisterLand = ({
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object().shape({
      ...
      ownerno: yup.string().required("land owner no is required !!"),
      purchaser_name: yup.string().required("purchaser name is required !!"),
      purchaser_no: yup.string().required("purchaser no is required !!"),
      staff_name: yup.string().required("staff name is required !!"),
      staff_no: yup.string().required("staff no is required !!"),
    }),
    onSubmit,
  });
...
export default WholeRegisterLand;
