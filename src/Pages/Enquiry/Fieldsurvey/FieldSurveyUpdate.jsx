...
import { EnquirySurveyUpdateStages } from "./EnquirySurveyUpdateStages";
          ...
          <div className="row">
            ...
            <TabView>
              <TabPanel header="Current">
                <EnquirySurveyUpdateStages eid={decryEid} id={decryId} status={decryStatus} landtype={decryLandtype} />
              </TabPanel>
              <TabPanel header="Remainder">
                ...
                <MandatoryDocumentUpdateStages eid={decryEid} status={'complete'} pagetype="reminder" landtype={decryLandtype} />
              </TabPanel>
            </TabView>
