...
import PattaDetailsLand from "./PattaDetailsLand";
import PattaSurveyLand from "./PattaSurveyLand";
import AadharDetailsLand from "./AadharDetailsLand";
import TitleDetailsLand from "./TitleDetailsLand";
import TitleSurveyLand from "./TitleSurveyLand";
// import FileViewUtils from "../../../../Utils/FileView/FileViewUtils";
// import { IMG_PATH } from "../../../../Api/api";
...
const AddMoreLand = ({ isOpen, closeModal, data }) => {
                ...
                <div className="col-6">
                  <div>
                    ...
                    >
                        ...
                        <>
                          {step === 1 &&
                            (isLoading == 1 ? (
                              ...
                              <>
                                <PattaDetailsLand data={data} setStep = {setStep} />
                              </>
                            ))}
                          {step === 2 && (
                            <>
                              <PattaSurveyLand data={data} />
                            </>
                          )}
                        </>
                      )}
                      ...
                      {data?.doc_type == "Aadhaar" && (
                        <AadharDetailsLand data={data} isOpen={isOpen} clearFormRef={formRef}/>
                      )}
                        ...
                        <>
                          {step === 1 &&
                            (isLoading == 4 ? (
                              ...
                              <>
                                <TitleDetailsLand data={data} setStep={setStep}/>
                              </>
                            ))}
                          {step === 2 && (
                            <>
                              <TitleSurveyLand data={data} />
                            </>
                          )}
