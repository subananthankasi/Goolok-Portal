...
const ServicePaymentTele = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/servicepayment/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
  };
              ...
              <div className="col-12">
                <div className="">
                  <div className="card-body">
                    <h4 className="page_heading">Service payment </h4>
...
export default ServicePaymentTele