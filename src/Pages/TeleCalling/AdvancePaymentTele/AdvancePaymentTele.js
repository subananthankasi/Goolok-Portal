...
const AdvancePaymentTele = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/telecalling_advance/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData(rowData.status)}`);
  };
              ...
              <div className="col-12">
                <div className="">
                  <div className="card-body">
                    <h4 className="page_heading">Invoice reports</h4>
...
export default AdvancePaymentTele;
