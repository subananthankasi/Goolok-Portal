...
const ServiceConfirmTele = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        `${API_BASE_URL}/teleservice/${staffid.Login === "admin" ? "all" : "pending"}`,
      );
      setLoading(false);
      setPendingData(
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(
      `/serviceconfirm/${encryptData(rowData.enqid)}/${encryptData(
        rowData.id
      )}/${encryptData("pending")}`
    );
  };
        ...
        <div className="container-fluid">
          {loading ? (
            ...
            <div className="">
              <div className="">
                <div className="">
                  <h4 className="page_heading">Service Confirmation</h4>
...
export default ServiceConfirmTele;
