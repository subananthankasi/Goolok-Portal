...
const disableStaffData = staffdata.filter((data) => data.status === "Disable")
...
const [editData,setEditData] = useState()
  ...
  const filterdata = SearchData(disableStaffData, filterText, searchColumns);
  /////////////////////////////////////
          ...
          <div className="row">
            <div className="col-12">
              <div className="card">
                ...
                <div className="d-flex">
                  <h4 className="page_heading">Disable Staff Report</h4>
                   <div style={{marginLeft:'auto'}}><ExportButton columns={columns} data={disableStaffData} filename={'Staff_Report.csv'}/></div>
                  </div>
                </div>
