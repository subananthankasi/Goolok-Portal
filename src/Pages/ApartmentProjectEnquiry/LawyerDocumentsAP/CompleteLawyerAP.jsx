...
const CompleteLawyerAP = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/aproject_lawyerdocument/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('complete')}`);
    };
...
export default CompleteLawyerAP;
