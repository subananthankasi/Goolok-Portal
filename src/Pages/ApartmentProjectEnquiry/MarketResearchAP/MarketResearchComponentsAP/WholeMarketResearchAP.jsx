...
import CustomerMarketAP from "./CustomerMarketAP";
import NearbyMarketAP from "./NearbyMarketAP";
import { useSelector } from "react-redux";

export const WholeMarketResearchAP = ({
  eid,
  marketid,
  status,
  subtype,
  ...
  const handleConfirm = async () => {
    ...
    try {
      await axios.get(`${API_BASE_URL}/aprtprtmarketconfirm/${marketid}`);
      Toast({ message: "Successfully Updated", type: "success" });
      setConfirmLoading(false)
      navigate("/aproject_marketresearch#Complete");
    } catch (error) {
      const errorMessage =
