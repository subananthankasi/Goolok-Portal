...
const PendingMarketAP = () => {
    ...
    const handleRowSelect = (args) => {
        ...
        navigate(`/aproject_marketresearch/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("pending")}`);
    };
...
export default PendingMarketAP