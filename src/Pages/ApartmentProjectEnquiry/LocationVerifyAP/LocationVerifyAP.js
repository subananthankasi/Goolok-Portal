...
import WaitingLocAp from "./WaitingLocAp";
import PendingLocAp from "./PendingLocAp";
import CompleteLocAp from "./CompleteLocAp";

const LocationVerifyAP = () => {
...
export default LocationVerifyAP;
