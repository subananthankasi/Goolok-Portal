...
// import GeneralFeatureContentAP from "./GeneralFeatureContentAP";
// import InteriorFeatureContentAp from "./InteriorFeatureContentAp";
// import ExteriorFeaturContentAp from "./ExteriorFeaturContentAp";
// import InvestmentStrategyContentAp from "./InvestmentStrategyContentAp";
// import ProjectDetailsContentAp from "./ProjectDetailsContentAp";
// import * as FaIcons from "react-icons/fa";

// const DescriptionContentAP = ({ eid, id, status }) => {
...
//       <ProjectDetailsContentAp eid={eid} id={id} status={status} />
//       <GeneralFeatureContentAP eid={eid} id={id} status={status} />
//       <InteriorFeatureContentAp eid={eid} id={id} status={status} />
//       <ExteriorFeaturContentAp eid={eid} id={id} status={status} />
//       <InvestmentStrategyContentAp eid={eid} id={id} status={status} />
//     </>
//   );
// };

// export default DescriptionContentAP;
...
const DescriptionContentAP = ({ eid, id, status, subtype }) => {
  const dispatch = useDispatch();
  const [amenities, setAmenities] = useState([]);
  const staffid = JSON.parse(localStorage.getItem("token"));
  const enquiryDoumentData = useSelector(
