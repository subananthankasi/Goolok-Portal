...
const CompletePricingAP = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/aproject_pricing/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData("complete")}`);
...
export default CompletePricingAP