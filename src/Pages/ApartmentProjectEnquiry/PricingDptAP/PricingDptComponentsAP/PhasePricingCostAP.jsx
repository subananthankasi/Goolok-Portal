...
const PhasePricingCostAP = ({ eid, id, status, pagetype }) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object().shape({
      phase: yup.string().required("block is required !!"),
      ...
      >
        <form onSubmit={formik.handleSubmit} autoComplete="off">
          ...
          <div className="form-group mt-1">
            <label className="form-label">
              {" "}
              No. of Flats: <span style={{ color: "red" }}>*</span>{" "}
            </label>
            <input
              type="text"
              className="form-control"
          ...
          <div className="form-group mt-1">
            <label className="form-label">
              {" "}
              Total Flat Cost: <span style={{ color: "red" }}>*</span>{" "}
            </label>
            <input
              type="text"
              className="form-control"
...
export default PhasePricingCostAP;
