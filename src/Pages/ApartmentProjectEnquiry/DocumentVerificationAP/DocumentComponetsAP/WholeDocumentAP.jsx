...
import AddMoreAP from "./AddMoreAP";
import AnotherAddMoreAP from "./AnotherAddMoreAP";

const WholeDocumentAP = ({ eid, id, status, pagetype }) => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      navigate("/aproject_document#Complete");
                ...
                <TabPanel header="Project Details">
                  <div className="row">
                    <div className="col-6">
                      ...
                      <div className="row mt-5">
                        <div className="col-6">Builder name :</div>
                        <div className="col-6">
                          {projectData?.developer_name}
                        </div>
                      </div>
                      <div className=" row mt-5">
                        <div className="col-6">Project Status :</div>
                        <div className="col-6">
                      ...
                      <div className=" row mt-5 mb-5">
                        ...
                        <div className="col-6">{projectData?.project_size}</div>
                      </div>
                      <div className=" row mt-5 mb-5">
                        <div className="col-6"> Total no of units :</div>
                        <div className="col-6">{projectData?.total_units}</div>
                      </div>
                    </div>
                    <div className="col-6">
                      <div className="row mt-5">
                        ...
                        <div className="col-6">
                          {projectData?.total_saleable_units}
                        </div>
                      </div>
                      <div className="row mt-5">
                        <div className="col-6">Configurations :</div>
                        <div className="col-6">
                          {projectData?.configurations}
                        </div>
                      </div>
                      <div className=" row mt-5">
                        <div className="col-6">Saleable units total sqft :</div>
                        <div className="col-6">
                          {projectData?.saleable_sqft}
                        </div>
                      </div>
                      <div className=" row mt-5">
                        <div className="col-6"> No of 2bhk :</div>
                        <div className="col-6">{projectData?.no_of_2bhk}</div>
                      </div>
                      <div className=" row mt-5">
                        <div className="col-6">No of 3bk :</div>
                        <div className="col-6">{projectData?.no_of_3bhk}</div>
                      </div>

                      <div className=" row mt-5 mb-5">
                        <div className="col-6"> No of 4bhk :</div>
                        <div className="col-6">{projectData?.no_of_4bhk}</div>
                      </div>
                    </div>
                  </div>
                </TabPanel>
...
export default WholeDocumentAP;
