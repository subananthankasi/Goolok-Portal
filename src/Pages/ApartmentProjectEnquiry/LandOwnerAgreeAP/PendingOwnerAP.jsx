...
const PendingOwnerAP = () => {
  ...
  const handleRowSelect = (args) => {
    ...
    navigate(`/aproject_landowneragreement/${encryptData(rowData.enqid)}/${encryptData(rowData.id)}/${encryptData('pending')}`);
  };
