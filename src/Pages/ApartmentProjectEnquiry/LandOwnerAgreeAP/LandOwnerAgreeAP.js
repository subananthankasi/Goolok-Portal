...
import WaitingOwnerAP from "./WaitingOwnerAP";
import PendingOwnerAP from "./PendingOwnerAP";
import CompleteOwnerAP from "./CompleteOwnerAP";


const LandOwnerAgreeAP = () => {
...
export default LandOwnerAgreeAP