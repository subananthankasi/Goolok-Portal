...
const Sidebars = () => {
  ...
  const [openMainMenu, setOpenMainMenu] = useState(() => {
    return localStorage.getItem("openMainMenu") || null;
  });

  const [openSubMenu, setOpenSubMenu] = useState(() => {
    return localStorage.getItem("openSubMenu") || null;
  });
  const [openThirdMenu, setOpenThirdMenu] = useState(() => {
    return localStorage.getItem("openThirdMenu") || null;
  });

  const toggleMainMenu = (menu) => {
    setOpenMainMenu((prev) => {
      const updated = prev === menu ? null : menu;
      localStorage.setItem("openMainMenu", updated);
      return updated;
    });
  ...
  const toggleSubMenu = (menu) => {
    setOpenSubMenu((prev) => {
      const updated = prev === menu ? null : menu;
      localStorage.setItem("openSubMenu", updated);
      return updated;
    });
  };
  const toggleThirdMenu = (menu) => {
    setOpenThirdMenu((prev) => {
      const updated = prev === menu ? null : menu;
      localStorage.setItem("openThirdMenu", updated);
      return updated;
    });
  };
            ...
            {loginType === "admin" && (
              <>
                <SubMenu
                  ...
                  open={openMainMenu === "MasterPage"}
                  onClick={() => toggleMainMenu("MasterPage")}
                >
                  {/* <Item
                    title="Property Type"
                    to="/property_type"
              ...
              /> */}
                ...
                <SubMenu
                  ...
                  open={openMainMenu === "Staff"}
                  onClick={() => toggleMainMenu("Staff")}
                >
                  <Item
                    title="New Staff"
                    to="/new_staff"
                ...
                >
                  ...
                  >
                    <SubMenu
                      ...
                      open={openThirdMenu === "HomeService"}
                      onClick={() => toggleThirdMenu("HomeService")}
                    >
                      <Item
                        title="BannerImage"
                    ...
                    <SubMenu
                      ...
                      open={openThirdMenu === "servicesubpages"}
                      onClick={() => toggleThirdMenu("servicesubpages")}
                    >
                      <Item
                        title="CustomerCare"
                        to="/customercare"
                ...
                <SubMenu
                  ...
                  open={openMainMenu === "Project"}
                  onClick={() => toggleMainMenu("Project")}
                >
                  <Item
                    title={
                      <div
                ...
                <SubMenu
                  ...
                  open={openMainMenu === "propertyinventory"}
                  onClick={() => toggleMainMenu("propertyinventory")}
                >
                  <Item
                    title="Vacant Report"
                    to="/VacantReport"
                ...
                <SubMenu
                  ...
                  open={openMainMenu === "booking"}
                  onClick={() => toggleMainMenu("booking")}
                >
                  <Item
                ...
                <SubMenu
                  ...
                  style={{ color: "White" }}
                  // open={openSubMenus["Service"]}
                  open={openMainMenu === "Service"}
                  onClick={() => toggleMainMenu("Service")}
                >
                  <Item
                    title={
                      <div
                ...
                <SubMenu
                  ...
                  open={openMainMenu === "LandService"}
                  onClick={() => toggleMainMenu("LandService")}
                >
                  <SubMenu
                    label="Get Patta"
                    icon={<ArticleIcon />}
                  ...
                  <SubMenu
                    ...
                    open={openSubMenu === "PropertyValuation"}
                  ...
                  <SubMenu
                    ...
                    open={openSubMenu === "MissingDocuments"}
                ...
                <SubMenu
                  ...
                  open={openMainMenu === "Apart Enquiry"}
                  onClick={() => toggleMainMenu("Apart Enquiry")}
                >
                  <Item
                    title="Document Verification"
                ...
                <SubMenu
                  ...
                  open={openMainMenu === "PlotEnquiry"}
                  onClick={() => toggleMainMenu("PlotEnquiry")}
                >
                  <Item
                    title="Document Verification"
                    to="/plot_document"
                ...
                <SubMenu
                  ...
                  open={openMainMenu === "HouseEnquiry"}
                  onClick={() => toggleMainMenu("HouseEnquiry")}
                >
                  <Item
                    title="Document Verification"
                    to="/house_document"
                ...
                <SubMenu
                  ...
                  open={openMainMenu === "LayoutEnquiry"}
                  onClick={() => toggleMainMenu("LayoutEnquiry")}
                >
                  <Item
                    title="Document Verification"
                    to="/layout_document"
                ...
                <SubMenu
                  ...
                  open={openMainMenu === "CommercialEnquiry"}
                  onClick={() => toggleMainMenu("CommercialEnquiry")}
                >
                  <Item
                    title="Document Verification"
                ...
                <SubMenu
                  ...
                  open={openMainMenu === "ApartmentProjectEnquiry"}
                  onClick={() => toggleMainMenu("ApartmentProjectEnquiry")}
                >
                  <Item
                    title="Document Verification"
                ...
                <SubMenu
                  ...
                  open={openMainMenu === "AfterSale"}
                  onClick={() => toggleMainMenu("AfterSale")}
                >
                  <Item
                    title="Booking"
                    to="/blockingbooking"
                ...
                {module?.includes(
                  "Land Enquiry") && (
                    <SubMenu
                      ...
                      open={openMainMenu === "LandEnquiry"}
                      onClick={() => toggleMainMenu("LandEnquiry")}
                    >
                ...
                {pages?.includes("Telecalling") && (
                  <>
                    <SubMenu
                      ...
                      style={{ color: "White" }}
                      // open={openSubMenus["Enquiry"]}
                      open={openMainMenu === "Telecalling"}
                      onClick={() => toggleMainMenu("Telecalling")}
                    >
                      <Item
                        title="Document verification"
                        to="/telecalling_documentverification"
